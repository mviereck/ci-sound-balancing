...
| 18 | init.js | Der große DOMContentLoaded-Handler mit `applyLang()`, `buildImplantCard()`, allen Event-Verdrahtungen, Autosave-Setup. Seit BA 106: Autosave-Load nutzt die gleiche Migrations-Sequenz wie der JSON-Load (`_fmCleanupLegacyFRes` → `_fmMigrateAltSliderFRes`). |
