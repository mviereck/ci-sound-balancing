...
export declare class RubberBandInterface {
    ...
    rubberband_live_new(sampleRate: number, channels: number, options: RubberBandOption): RubberBandLiveState;
    ...
    rubberband_live_set_formant_option(state: RubberBandLiveState, options: RubberBandOption): void;
