...
const L = {
  de: {
    ...
    pwWarning: "Das Frequenz-Warping basiert auf der subjektiven Tagesmessung im Frequenzabgleich-Test. Die Wahrnehmung kann sich über Wochen ändern. Bei stärkeren Verschiebungen treten Klangartefakte auf (leicht »phasige« Klangfarbe). Experimentell. – Bandweise Pitch-Shift und Phasen-Vocoder benötigen keine Vorberechnung; Änderungen wirken beim nächsten Play. Bei stark unterschiedlichen Pitch-Shifts pro Frequenzbereich liefert der Phasen-Vocoder die beste Qualität, bei moderaten Shifts ist Offline-Vorberechnung am natürlichsten. Bandweise Pitch-Shift ist der schnellste Modus mit guter Qualität bei kleinen Shifts.",
  ...
  en: {
    ...
    pwWarning: "Frequency warping is based on the subjective daily measurement from the frequency matching test. Perception may change over weeks. Larger shifts will produce audible artefacts (slightly 'phasey' timbre). Experimental. – Band-wise Pitch Shift and Phase Vocoder require no pre-computation; changes take effect on the next Play. For strongly varying pitch shifts across frequency regions, the Phase Vocoder delivers the best quality; for moderate shifts, Offline Pre-computation sounds most natural. Band-wise Pitch Shift is the fastest mode with good quality for small shifts.",
  ...
  fr: {
    ...
    pwWarning: "La distorsion de fréquences est basée sur la mesure subjective du jour effectuée lors du test de correspondance de fréquences. La perception peut évoluer sur plusieurs semaines. Des décalages importants produisent des artefacts sonores (timbre légèrement « déphasé »). Expérimental. – Le décalage par bandes et le vocodeur de phase ne nécessitent pas de précalcul ; les modifications prennent effet à la prochaine lecture. Pour des décalages très variables selon la fréquence, le vocodeur de phase offre la meilleure qualité ; pour des décalages modérés, le précalcul hors ligne est le plus naturel. Le décalage par bandes est le mode le plus rapide avec une bonne qualité pour de petits décalages.",
  ...
  es: {
    ...
    pwWarning: "La distorsión de frecuencias se basa en la medición subjetiva del día realizada en el test de correspondencia de frecuencias. La percepción puede cambiar a lo largo de semanas. Los desplazamientos grandes producen artefactos sonoros (timbre ligeramente «desfasado»). Experimental. – El desplazamiento por bandas y el vocodificador de fase no requieren precálculo; los cambios surten efecto en la próxima reproducción. Para desplazamientos muy variables según la frecuencia, el vocodificador de fase ofrece la mejor calidad; para desplazamientos moderados, el precálculo fuera de línea suena más natural. El desplazamiento por bandas es el modo más rápido con buena calidad para pequeños desplazamientos.",
