...
const L = {
  de: {
    ...
    pwMethodLive: "Live (mit Latenz)",
    pwMethodBandShift: "Bandweise Pitch-Shift",
    ...
    pwWarning: "Das Frequenz-Warping basiert auf der subjektiven Tagesmessung im Frequenzabgleich-Test. Die Wahrnehmung kann sich über Wochen ändern. Bei stärkeren Verschiebungen treten Klangartefakte auf (leicht »phasige« Klangfarbe). Experimentell.",
  ...
  en: {
    ...
    pwMethodLive: "Live (with latency)",
    pwMethodBandShift: "Band-wise Pitch Shift",
    ...
    pwWarning: "Frequency warping is based on the subjective daily measurement from the frequency matching test. Perception may change over weeks. Larger shifts will produce audible artefacts (slightly 'phasey' timbre). Experimental.",
  ...
  fr: {
    ...
    pwMethodLive: "En direct (avec latence)",
    pwMethodBandShift: "Décalage par bandes",
    ...
    pwWarning: "La distorsion de fréquences est basée sur la mesure subjective du jour effectuée lors du test de correspondance de fréquences. La perception peut évoluer sur plusieurs semaines. Des décalages importants produisent des artefacts sonores (timbre légèrement « déphasé »). Expérimental.",
  ...
  es: {
    ...
    pwMethodLive: "En directo (con latencia)",
    pwMethodBandShift: "Desplazamiento por bandas",
    ...
    pwWarning: "La distorsión de frecuencias se basa en la medición subjetiva del día realizada en el test de correspondencia de frecuencias. La percepción puede cambiar a lo largo de semanas. Los desplazamientos grandes producen artefactos sonoros (timbre ligeramente «desfasado»). Experimental.",
