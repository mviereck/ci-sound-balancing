...
const L = {
  de: {
    ...
    subTabLoudness: "Elektrodenlautstärke",
    subTabFreqMatch: "Frequenzabgleich",
    fmrTitle: "Frequenzabgleich Links/Rechts",
    ...
    fmrChartYLabel: "Subjektive Frequenz (Hz)",
    fmrChartDiagonal: "Perfekter Match",
    fmrChartHint: "Punkte auf der Diagonalen = subjektive Wahrnehmung entspricht der vom CI verwendeten Frequenz. Punkte oberhalb = das CI-Frequenzband wird subjektiv tiefer gehört als seine technische Frequenz. Punkte unterhalb = umgekehrt.",
  ...
  en: {
    ...
    subTabLoudness: "Electrode Loudness",
    subTabFreqMatch: "Frequency Matching",
    fmrTitle: "Frequency Matching Left/Right",
    ...
    fmrChartYLabel: "Subjective Frequency (Hz)",
    fmrChartDiagonal: "Perfect Match",
    fmrChartHint: "Points on the diagonal = subjective perception matches the frequency used by the CI. Points above = the CI frequency band is perceived as lower than its technical frequency. Points below = the opposite.",
  ...
  fr: {
    ...
    fmResColCent: "Écart",
    subTabLoudness: "Intensité des électrodes",
    subTabFreqMatch: "Correspondance de fréquences",
    fmrTitle: "Correspondance de fréquences Gauche/Droite",
    ...
    fmrChartYLabel: "Fréquence subjective (Hz)",
    fmrChartDiagonal: "Correspondance parfaite",
    fmrChartHint: "Points sur la diagonale = la perception subjective correspond à la fréquence utilisée par l'IC. Points au-dessus = la bande de fréquences de l'IC est perçue plus grave que sa fréquence technique. Points en-dessous = l'inverse.",
  ...
  es: {
    ...
    subTabLoudness: "Intensidad de electrodos",
    subTabFreqMatch: "Correspondencia de frecuencias",
    fmrTitle: "Correspondencia de frecuencias Izquierda/Derecha",
    ...
    fmrChartYLabel: "Frecuencia subjetiva (Hz)",
    fmrChartDiagonal: "Correspondencia perfecta",
    fmrChartHint: "Puntos en la diagonal = la percepción subjetiva coincide con la frecuencia usada por el IC. Puntos por encima = la banda de frecuencias del IC se percibe más grave que su frecuencia técnica. Puntos por debajo = lo contrario.",
