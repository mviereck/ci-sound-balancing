...
const L = {
  de: {
    ...
    fmHintWarn:
      "Für brauchbare Ergebnisse müssen vorher der Lautstärkenausgleich (Reiter Messungen → Elektrodenlautstärke) für beide Seiten und die Stereo-Balance durchgeführt sein. Die Töne müssen links und rechts gleich laut wirken, sonst werden die Frequenzwahrnehmungen verfälscht.",
    fmHintMethod:
      "Die Tonhöhenwahrnehmung beim CI ist plastisch und schwankt zwischen Messungen. Das Tool zeigt eine subjektive Momentaufnahme, kein objektives anatomisches Maß. Wiederholte Messungen über Wochen sind sinnvoller als eine einzelne. Ergebnisse dienen als Gesprächsgrundlage mit dem Audiologen.",
    ...
    lrDesc: "Dieser Test vergleicht die wahrgenommene Lautstärke links und rechts für jedes Elektrodenpaar.",
    lrOrderLbl: "Reihenfolge:",
    lrSideLbl: "Seitenfolge:",
    testExplainRecommend: "Empfehlung: Führen Sie zunächst einen vollständigen Durchlauf (Round-Robin) durch, um eine zuverlässige Ausgangsbasis zu erstellen.",
    testExplainVarious: "Sie können zwischen dem Balancing-Modus (Slider) und dem Urteilsmodus (A lauter / gleich / B lauter) wählen.",
  },
  en: {
    subtitle: "CI Sound Balancing Tool · v2.7",
    sideLeft: "LEFT",
    ...
    fmHintWarn:
      "For meaningful results, you should first complete the loudness balancing (Measurements → Electrode loudness) for both sides and the stereo balance. The tones must sound equally loud on both sides, otherwise the frequency perception will be distorted.",
    fmHintMethod:
      "Pitch perception with a CI is plastic and varies between measurements. The tool shows a subjective snapshot, not an objective anatomical measure. Repeated measurements over weeks are more meaningful than a single one. Results serve as a basis for discussion with the audiologist.",
    ...
    lrDesc: "This test compares the perceived loudness left and right for each electrode pair.",
    lrOrderLbl: "Order:",
  ...
  fr: {
    ...
    fmHintWarn:
      "Pour des résultats utiles, l'équilibrage du volume (Mesures → Volume des électrodes) doit avoir été effectué au préalable pour les deux côtés, ainsi que la balance stéréo. Les sons doivent être perçus avec le même volume à gauche et à droite, sinon la perception des fréquences sera faussée.",
    fmHintMethod:
      "La perception de la hauteur avec un implant cochléaire est plastique et varie d'une mesure à l'autre. L'outil présente un instantané subjectif, pas une mesure anatomique objective. Des mesures répétées sur plusieurs semaines sont plus pertinentes qu'une mesure unique. Les résultats servent de base de discussion avec l'audiologiste.",
    ...
    lrDesc: "Ce test compare le volume perçu gauche et droite pour chaque paire d'électrodes.",
    lrOrderLbl: "Ordre :",
  ...
  es: {
    ...
    fmHintWarn:
      "Para obtener resultados útiles, primero deben realizarse el equilibrado del volumen (Mediciones → Volumen de electrodos) para ambos lados y el balance estéreo. Los tonos deben sonar igual de fuerte a la izquierda y a la derecha; de lo contrario, la percepción de las frecuencias se distorsionará.",
    fmHintMethod:
      "La percepción de la altura tonal con implante coclear es plástica y varía entre mediciones. La herramienta muestra una instantánea subjetiva, no una medida anatómica objetiva. Las mediciones repetidas durante semanas son más significativas que una sola medición. Los resultados sirven como base para la conversación con el audiólogo.",
    ...
    lrDesc: "Esta prueba compara el volumen percibido izquierdo y derecho para cada par de electrodos.",
    lrOrderLbl: "Orden:",
