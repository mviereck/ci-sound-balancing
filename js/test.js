// ============================================================
// ROUND_ROBIN — Rundenplan des Elektrodenlautstaerke-Tests.
// Pro Elektrodenzahl (12/16/22) eine Liste von Runden; jede Runde
// ist eine VOLLSTAENDIGE Paarung (jede Elektrode genau einmal, N-1
// Runden, alle N*(N-1)/2 Paare genau einmal). Die Vollstaendigkeit
// sichert gleiches Gewicht je Elektrode bei jedem Abbruch.
//
// Reihenfolge (0.6.551.2, loeste den frueheren Kreisplan ab; alter
// Plan archiviert in .docs/Archiv_RoundRobin_alt.md): die Runden sind
// nach Paar-DISTANZ gestaffelt — nahe Paare in fruehen Runden, die
// entferntesten Paare (z.B. E1-E12) erst in den letzten Runden. Grund:
// weit entfernte Tonhoehen sind in der Lautheit schwer zu vergleichen;
// wer den Test frueh abbricht, misst nur gut vergleichbare Paare, die
// mittleren "Bruecken"-Distanzen sind aber schon frueh dabei.
//
// Konstruktion (offline gerechnet, nicht zur Laufzeit):
//  1. Greedy je Runde die distanz-kleinste noch moegliche perfekte
//     Paarung; Runden dann nach mittlerer Distanz sortiert (nah->fern).
//  2. Reihenfolge INNERHALB der Runde: maximale Regionen-Trennung —
//     aufeinanderfolgende Paare treffen moeglichst verschiedene
//     Cochlea-Gegenden (keine gleitende Nachbar-Kette wie E1+E2,E2+E3).
// randAB(shuffle(...)) in startTestFull/nextFullRound wuerfelt zusaetzlich
// A/B-Seite und mischt die Runde erneut — die Distanz-Staffelung ZWISCHEN
// den Runden bleibt davon unberuehrt (nur die Reihenfolge in der Runde).
// ============================================================
const ROUND_ROBIN = {
  12: [
    [
