...
Object.assign(L.en, {
    ...
    LTZ_BTWarning: "<strong>⚠️ Important: Only perform this test with wired headphones.</strong><br>Bluetooth adds its own, different latencies per ear and distorts the measurement. Other tests work with Bluetooth — this one does <em>not</em>.",
    LTZ_measTitle: "Latency measurement",
    LTZ_maturityHint: "This test is already usable and works. Further improvements are likely to come.",
