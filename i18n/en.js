...
Object.assign(L.en, {
    ...
    latClearBtnLabel: "🗑 Clear latency result",
    latClearConfirm: "Delete latency measurement result?",
    ...
    latUniqueRange: "Unambiguous range:",
    latUniqueRangeAmbig: "(at larger offsets the direction becomes ambiguous)",
    yes: "yes",
    no: "no",
    introAudioDesc:
    ...
    audiologPrint: "Print (with graphic)",
    ...
    cfgLblEnCI: "E",
    cfgLblEnAcoustic: "B",
    plWarpExpNote: "Experimental option, modest sound quality",
    ...
    pwEngineR3:    "R3 Finer (quality)",
    pwEngineR2:    "R2 Faster (classic)",
    pwMaterialLabel:      "Material",
    pwMaterialStandard:   "Standard",
    pwMaterialSpeech:     "Speech",
    pwMaterialPercussive: "Percussive",
    pwMaterialR3Hint:     "With R3, material acts only via the window size.",
    pwOptionsLabel: "Options",
    pwOptFormant:   "Preserve formants",
    pwOptFast:      "Fast",
    pwStatusReady: "Ready",
    ...
    latPrereqHint: "First run the electrode loudness and stereo balance measurements for both sides.",
