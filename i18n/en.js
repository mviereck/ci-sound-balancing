...
Object.assign(L.en, {
    ...
    introDesc:
      "This tool helps CI users systematically compare the perceived loudness of their electrodes and create an individual correction curve. The goal is to set exactly equal loudness across all electrodes – the fundamental basis for good hearing with a CI. This setting is optimal for music and natural sounds. Adjustments for speech intelligibility or effects such as bass boost are also possible and can be tested live.<br>In addition, pitch perception can be measured, comparing the left and right ear. Based on the measured frequencies, the audiologist can adjust the CI so that the pitches sound the same on the left and right.",
    introWhat: "What is the workflow?",
    introFlowDesc:
      "<b>1. Side selection</b> – Select the side at the top: LEFT or RIGHT.<br><b>2. Implant tab</b> – Enter your manufacturer for the CI side(s). If known, correct the frequency band values per electrode. Default values are pre-configured. <b>Important:</b> Deactivated electrodes must be unchecked in the column “Active”.<br><b>3. Implant tab: other side</b> – Make entries there as well. If you do not wear a CI on that side, state how you hear there (normal, hard of hearing, deaf).<br><b>4. Volume</b> – Set the volume of your PC or smartphone to about 3/4. Not quiet, but not yet uncomfortably loud.<br><b>5. Measurement</b> – Select the CI side and start a test series under “Measurements” → “Electrode loudness”. The tool plays pairs of tones; adjust the settings until both tones sound equally loud. With two CIs, run the measurement for both sides.<br><b>6. Player</b> – Load a music file and listen to the difference with and without the correction.<br><b>7. Stereo balance</b> – Under “Measurements” → “Stereo balance” you can adjust the volume difference between left and right.<br><b>8. Latency</b> – Under “Measurements” → “Latency” you can correct a time offset between left and right, if present.<br><b>9. Frequency matching</b> – Under “Measurements” → “Frequency matching” you can measure pitch so that it sounds equally high or low on the left and right.<br><b>10. Player</b> – Test again in the player. You can also activate “Frequency warping” there if you have run a frequency matching test.<br><b>11. Curves and sliders</b> – In the “Curves” and “Sliders” tabs you can further fine-tune electrode loudness, e.g. for speech optimization. You can hear setting changes live while audio is playing.",
    introWarn:
    ...
    tabLTZ: "Latency",
    LTZ_startBtn: "▶ Start test",
    LTZ_stopBtn: "■ Stop",

    LTZ_resTitle: "Latency",
    LTZ_resLabel: "Measured time offset",
    LTZ_resNoneText: "No latency measured yet. Run under “Measurements” → “Latency”.",
    LTZ_resNoOffset: "No offset.",
    LTZ_resLeftFaster: "Left side was {ms} ms faster.",
    LTZ_resRightFaster: "Right side was {ms} ms faster.",
    LTZ_resMeasuredWith: "Measured with",
    LTZ_resInterval: "Click interval",
    LTZ_resApplied: "Applied in player",
    LTZ_clearBtnLabel: "🗑 Clear latency result",
    LTZ_clearConfirm: "Delete latency measurement result?",
    LTZ_typeClick: "Click (broadband)",
    LTZ_typeBurst500: "Low tone 500 Hz",
    LTZ_typeBurst1500: "Mid tone 1500 Hz",
    LTZ_typeBurst4000: "High tone 4 kHz",
    LTZ_BTWarning: "You need headphones for this test. Bluetooth introduces its own significant latencies. Only use Bluetooth if you specifically want to measure Bluetooth latency.",
    LTZ_measTitle: "Latency measurement",
    LTZ_maturityHint: "This test is accurate enough to correct the time offset far enough that tones merge again. It is not fine enough to optimize directional hearing.",
    LTZ_measIntro2: "Measurement of the time offset between left and right when tones arrive.",
    LTZ_locHint: "If the loudness of left and right is very well balanced, you can also pay attention to ‘where’ you hear the sound as a guide. More to the left, right, or centered in your head.",
    LTZ_measIntro: "Use the slider to set the offset at which the clicks are perceived simultaneously. Arrow keys: 1 ms — Shift+Arrow: 0.1 ms — Ctrl+Arrow: 10 ms.",
    LTZ_sliderMinusLabel: "−200 ms (delay right)",
    LTZ_sliderZeroLabel: "0",
    LTZ_sliderPlusLabel: "+200 ms (delay left)",
    LTZ_intervalLabel: "Click interval",
    LTZ_typeLabel: "Sound type",
    LTZ_audibleLabel: "Audible during measurement",
    LTZ_toggleClicks: "Clicks audible",
    LTZ_togglePlayer: "Player audible",
    LTZ_lockedHint: "Test is running. Stop the test to switch tabs.",
    LTZ_uniqueRange: "Unambiguous range:",
    LTZ_uniqueRangeAmbig: "(at larger offsets the direction becomes ambiguous)",
    yes: "yes",
    no: "no",
    introAudioDesc:
      "The results can be printed from the Load/Save tab. The printout contains the measurement results, your desired corrections, and the resulting equalizer values.",
    ...
    implValidatePrefixL2: "Caution:",
    implValidatePrefixL3: "Anomaly:",
    implValidatePrefixL4: "Note:",
    ...
    implValidateInfoAllActive: "No electrode marked as inactive. Please check whether this is correct.",
    implValidateFspNone: "No electrode marked for fine structure ({strat}). With {strat} the apical electrodes are usually driven by fine structure — please check.",
    implValidateFspOnlyE1: "Only E1 marked for fine structure ({strat}). With {strat} several apical electrodes are usually involved — please check whether this is correct.",
    implValidateFspGap: "Fine-structure electrodes not marked contiguously from E1 (E{gap} skipped). A continuous run from E1 is expected — please check.",
    implValidateInfoUpperEmpty: "No {label} values entered — {unit} values cannot be computed for the printout, only dB. No absolute values can be displayed in the Sliders tab.",
    ...
    implValidateInfoCodingUnknown: "No coding strategy specified. Please add this information.",
    sweep: "▶ Sweep",
    stop: "■ Stop",
    ...
    ELL_distWeightLabel: "Weighting of distant pair measurements:",
    ELL_dwVoll:   "Full",
    ELL_dwMittel: "Medium",
    ELL_dwGering: "Low",
    ...
    plNoiseAxisSpectrum: "Spectrum",
    plNoiseAxisStationary: "Time course",
    plNoiseAxisLoopSafe: "Loopable",
    ...
    plNoiseKind_wetter: "Weather",
    plNoiseKind_tier: "Animal",
    plNoiseKind_haushalt: "Household",
    plNoiseKind_industrie: "Industry",
    plNoiseKind_crowd: "Crowd",
    plNoiseKind_ambient: "Ambient",
    plNoiseKind_test_ton: "Test tone",
    plNoiseSpectrum_broadband: "Broadband",
    plNoiseSpectrum_lowpass: "Low-pass",
    plNoiseSpectrum_highpass: "High-pass",
    plNoiseSpectrum_bandpass: "Band-pass",
    plNoiseSpectrum_tonal: "Tonal",
    plNoiseStationary_y: "steady",
    plNoiseStationary_n: "changing",
    plNoiseLoopSafe_y: "seamlessly loopable",
    plNoiseLoopSafe_n: "not loopable",
    toggleOn: "ON",
    toggleOff: "OFF",
    plEqName: "Equalizer",
    ...
    plTextFontSmaller: "Smaller text",
    plTextFontLarger: "Larger text",
    plTextLineTighter: "Tighter lines",
    plTextLineLooser: "Looser lines",
    ...
    plReadAlongTitle: "Read along (estimated position):",
    plReadShowText: "Show text",
    plReadFind: "Find position",
    plReadAutoscroll: "Autoscroll",
    ...
    plWordBand_wort:          "Single word",
    plWordBand_wortpaar:          "Word pair",
    plWordBand_kurz:        "Short sentence",
    plWordBand_lang:       "Long sentence",
    plWordBand_sehrlang:     "Very long sentence",
    plAxisGender:           "Gender",
    ...
    plVariant_SE:           "Sweden",
    plVariant_NO:           "Norway",
    plVariant_NL:           "Netherlands",
    plVariant_US:           "United States",
    plVariant_GB:           "United Kingdom",
    plVariant_BE:           "Belgium",
    plVariant_IE:           "Ireland",
    plVariant_IN:           "India",
    plVariant_AM:           "Armenia",
    plVariant_NP:           "Nepal",
    plVariant_sursilv:      "Sursilvan",
    plVariant_vallader:     "Vallader",
    plAxisStyle:            "Recording type",
    plAxisTestSet:          "Test-sentence set",
    plAxisAccent:           "Accent",
    plAxisEmotion:          "Emotion",
    plAxisEmotion_neutral:   "neutral",
    plAxisEmotion_amused:    "amused",
    plAxisEmotion_angry:     "angry",
    plAxisEmotion_disgusted: "disgusted",
    plAxisEmotion_drunk:     "drunk",
    plAxisEmotion_sleepy:    "sleepy",
    plAxisEmotion_surprised: "surprised",
    plAxisEmotion_whisper:   "whispering",
    plAxisGender_m:         "male",
    plAxisGender_w:         "female",
    plAxisGender_u:         "unknown",
    plAxisGender_i:         "intersex",
    plAxisStyle_studio:     "Studio",
    plAxisStyle_narration:  "Narrated",
    plAxisStyle_test:       "Speech test",
    plAxisStyle_emotional:  "Emotional",
    plAxisStyle_dialect:    "Dialect",
    plAxisStyle_crowdsourced: "Everyday",
    ...
    archivSecELL: "Measurements",
    archivSecSchieberELL: "Sliders",
    archivSecKurvenELL: "Curves",
    ...
    archivLTZClick: "Click type",
    archivLTZInterval: "Interval",
    ...
    archivSchieberELLMode: "Sliders tab: mode",
    archivSchieberELLVariant: "Sliders tab: variant",
    archivSchieberELLShowMeas: "Sliders tab: show measurement",
    archivSchieberELLShowCurves: "Sliders tab: show curves",
    ...
    audiologWarnEqOff: "All corrections are switched off in the player (EQ off). This printout therefore contains no correction settings. You probably want to turn the correction on before exporting.",
    audiologWarnMeasuredNoEQ: "Electrode loudness measurement results are available, but the electrode loudness correction is not enabled in the player (EQ off). This printout therefore contains no electrode loudness correction. You probably want to enable the Equalizer.",
    audiologWarnMeasuredNoWarp: "Frequency-matching results are available, but frequency warping is not enabled in the player. This printout therefore contains no frequency requests. You probably want to enable frequency warping.",
    audiologWarnNhSim: "The simulation for normal-hearing listeners is active. The values given here reproduce that simulation and are also reported as a settings request. You probably do not want that.",
    audiologWarnAcousticWarp: "Frequency warping “{mode}” changes the frequencies on an ear without a cochlear implant. No frequency setting can be programmed into the implant there.",
    audiologWarnAcousticWarpFix: "You probably want the setting “{ciSide}”.",
    ...
    audiologLTZValue: "Inter-ear delay",
    audiologLTZImpact: "{earlier} is heard earlier, {later} later.",
    ...
    schieberELLShowLabel: "Show:",
    schieberELLSrcSlider: "Sliders",
    schieberELLSrcMeas: "Measurement",
    schieberELLSrcCurves: "Curves",
    schieberELLReset: "Reset manual values to 0",
    schieberELLElLabel: "Electrode",
    schieberELLVlLabel: "Value",
    schieberELLKeyHint: "Tip: Left/right arrow keys switch electrodes, up/down change the value. Use Shift for a smaller step.",
    schieberELLWarpHint:
      "Frequency warping active — the displayed curves shift " +
      "slightly per electrode.",
    schieberELLModeLabel: "Mode:",
    schieberELLModeRelative: "relative (dB)",
    schieberELLModeAbsolute: "absolute (qu/CL/CU)",
    schieberELLVariantLabel: "Display:",
    schieberELLVarSum: "sum only",
    ...
    lblImplCoding: "Coding strategy:",
    implCodingUnknown: "unknown",
    ...
    FRQ_resultsColNominalHz: "center geom. (arith.)",
    FRQ_resultsColPerceivedHz: "Hz perceived",
    FRQ_resultsSidesDescription1: "Measurement results for side {side}:",
    ...
    FRQ_resultsColRestspanne:    "Residual span (ct)",
    FRQ_resultsColRestspanneTip: "Resolution reached last: half the distance between the just-lower and the just-higher tone of the finest round.",
    FRQ_resultsColResiduum:      "Residuum (ct)",
    FRQ_resultsColResiduumTip:   "Scatter across the run: how far the boundaries were taken back. Range -lower ... +upper around the result; asymmetric.",
    ...
    FRQ_resultsStatusPianoCrossed:   "Result crossed",
    FRQ_resultsStatusPianoWide:      "Result — span too wide",
    FRQ_resultsStatusNotPerceivable: "✗ not perceivable",
    FRQ_resultsStatusNotActive: "deactivated",
    ...
    FRQ_resultsTipRestspanne: "residual span",
    FRQ_resultsTipResiduum: "residuum",
    ...
    FRQ_resultsChartHintPiano:      "Actual line = programmed electrode frequency, target point = perceived match. Black bar / amber band = residuum (scatter across the run, asymmetric), blue bar = residual span (resolution reached last).",
    FRQ_legLegende: "Legend:",
    FRQ_legElement_strichGrau:    "Vertical line",
    FRQ_legElement_strichSchwarz: "Vertical line",
    FRQ_legElement_pfeil:         "Arrow",
    FRQ_legElement_punkt:         "Dot",
    FRQ_legElement_band:          "Band",
    FRQ_legElement_querbalken:    "Cross bar",
    FRQ_legElement_querbalkBlau:  "Cross bar",
    FRQ_legElement_kurve:         "Curve",
    FRQ_legElement_flaeche:       "Area",
    FRQ_legFarbe_hellgrau:     "light grey",
    FRQ_legFarbe_schwarz:      "black",
    FRQ_legFarbe_orange:       "orange",
    FRQ_legFarbe_blau:         "blue",
    FRQ_legFarbe_gruen:        "green",
    FRQ_legFarbe_hellblau:     "light blue",
    FRQ_legFarbe_weiss:        "white",
    FRQ_legFarbe_hellrot:      "light red",
    FRQ_legFarbe_gruenrot:     "green/red",
    FRQ_legFarbe_gruengelbrot: "green/yellow/red",
    FRQ_legIntro_ergebnis: "Graph shows the actual/target difference on both the X and Y axis.",
    FRQ_legIntro_glaett:   "Graph shows the measured/smoothed difference on both the X and Y axis.",
    FRQ_legIntro_band:     "Graph shows computed band boundaries and the resulting centre frequencies.",
    FRQ_legStufe_ampel_gruen: "within measurement uncertainty",
    FRQ_legStufe_ampel_gelb:  "slightly outside measurement uncertainty",
    FRQ_legStufe_ampel_rot:   "clearly outside measurement uncertainty",
    FRQ_legStufe_problem_gruen: "measurement looks correct",
    FRQ_legStufe_problem_rot:   "measurement problematic, see table",
    FRQ_legStufe_ampel_ungemessen:   "not measured",
    FRQ_legStufe_problem_ungemessen: "not measured",
    FRQ_leg_ergebnis_strichGrau:    "Nominal frequency (currently set in the CI)",
    FRQ_leg_ergebnis_strichSchwarz: "Measured frequency",
    FRQ_leg_ergebnis_pfeil:         "Shift from nominal to measured",
    FRQ_leg_ergebnis_punkt:         "Magnitude of the shift",
    FRQ_leg_ergebnis_band:          "Measurement uncertainty",
    FRQ_leg_ergebnis_querbalkBlau:  "Residual span (resolution reached last)",
    FRQ_leg_ergebnis_querbalken:    "Residuum (scatter across the run, asymmetric)",
    FRQ_leg_ergebnis_kurve_blau:    "Measurement results",
    FRQ_leg_glaett_strichGrau:    "Measured frequency",
    FRQ_leg_glaett_strichSchwarz: "Frequency shifted by smoothing",
    FRQ_leg_glaett_pfeil:         "Shift from measured to smoothed",
    FRQ_leg_glaett_punkt:         "Deviation from the measurement",
    FRQ_leg_glaett_querbalkBlau:  "Residual span (resolution reached last)",
    FRQ_leg_glaett_querbalken:    "Residuum (scatter across the run, asymmetric)",
    FRQ_leg_glaett_kurve_blau:    "Measurement results",
    FRQ_leg_glaett_kurve_gruen:   "Smoothing curve",
    FRQ_leg_band_strichGrau:    "Selected reference",
    FRQ_leg_band_strichSchwarz: "Centre frequency reached by band computation",
    FRQ_leg_band_pfeil:         "Shift to band centre",
    FRQ_leg_band_punkt:         "Deviation from band centre",
    FRQ_leg_band_querbalkBlau:  "Residual span (resolution reached last)",
    FRQ_leg_band_querbalken:    "Residuum (scatter across the run, asymmetric)",
    FRQ_leg_band_kurve_blau:    "Measurement results",
    FRQ_leg_band_kurve_gruen:   "Smoothing curve",
    FRQ_leg_band_kurve_grau:    "Nominal frequency",
    FRQ_leg_band_flaeche_hellblau: "Frequency band",
    FRQ_leg_band_flaeche_weiss:    "Gap, not covered by any frequency band",
    FRQ_leg_band_flaeche_hellrot:  "Band overlap",
    // Bar-graph legend ELL + Stereo (BA496)
    FRQ_legElement_balken:        "Bar",
    FRQ_legElement_xRechteck:     "Box with cross",
    FRQ_legElement_frageRechteck: "Box with question mark",
    FRQ_legElement_meanLinie:     "Dashed line",
    FRQ_legFarbe_rotblau:         "red/blue",
    FRQ_legIntro_ellbar:  "Graph shows the measured loudness deviation per electrode.",
    FRQ_legIntro_stbbar:  "Graph shows the right/left loudness difference per electrode.",
    FRQ_leg_ellbar_balken:        "Measured loudness (negative = too soft, positive = too loud)",
    FRQ_legStufe_ellampel_gruen: "Measurement uncertainty < 1 dB, very good measurement",
    FRQ_legStufe_ellampel_gelb:  "Measurement uncertainty < 3 dB, good measurement",
    FRQ_legStufe_ellampel_rot:   "Measurement very uncertain",
    FRQ_leg_ellbar_querbalken:    "Measurement uncertainty",
    FRQ_leg_ellbar_xRechteck:     "Electrode disabled or muted",
    FRQ_leg_ellbar_frageRechteck: "Electrode active but not yet measured",
    FRQ_leg_stbbar_balken:        "Perceived loudness difference (deflection toward the louder side)",
    FRQ_leg_stbbar_xRechteck:     "Electrode disabled or muted",
    FRQ_leg_stbbar_frageRechteck: "Electrode active but not yet measured",
    FRQ_leg_stbbar_meanLinie:     "Mean balance across all active electrodes",
    ...
    FRQ_glaettIntro: "<p style=\"margin:0 0 8px\">Reproducing the exact measured values as closely as possible can lead to an uneven distribution of frequency bands. Smoothing the measurement curve can yield a more even band distribution.</p><p style=\"margin:0 0 6px\">There are two possible goals for smoothing:</p><ol style=\"margin:0 0 8px;padding-left:1.4em\"><li>Approximating the structure of the electrode spacings: the “Place-affine” method or, alternatively, “Polynomial” with its default settings is particularly suited to this. The resulting curve looks almost linear.</li><li>Approximation with a flexible polynomial curve. It stays closer to the measured values and smooths only the outliers.</li></ol><ul style=\"margin:0 0 8px;padding-left:1.4em\"><li>The coloured green/amber/red dots indicate how well the curve fits your measurement.</li><li>The T-shaped residual bars show the measurement uncertainty; the better the curve runs through the residuals, the better it matches your measurements.</li><li>Electrodes marked as problematic (e.g. noisy) may change substantially in the curve.</li></ul>",
    FRQ_glaettVerfahrenLegend: "Method",
    FRQ_glaettVerfahrenAus: "off",
    FRQ_glaettVerfahrenPoly: "Polynomial",
    ...
    FRQ_glaettFitXLegend: "Curve over",
    FRQ_glaettFitXPos: "Electrode place",
    FRQ_glaettFitXIdx: "Electrode number",
    FRQ_glaettGrundlageLegend: "Smoothing basis",
    FRQ_glaettGrundlageResiduum: "Residuum range",
    FRQ_glaettGrundlageRestspanne: "Residual span",
    FRQ_glaettFormelLegend: "Weight formula",
    FRQ_glaettFormelLinear: "1/r",
    FRQ_glaettFormelQuadrat: "1/r²",
    FRQ_glaettFormelQuartisch: "1/r⁴",
    FRQ_glaettFormelGleich: "all equal",
    FRQ_glaettBodenLegend: "Weight floor",
    FRQ_glaettAnkerLegend: "Stiffness coupling",
    FRQ_glaettAnkerGekoppelt: "coupled to weight",
    FRQ_glaettAnkerEntkoppelt: "decoupled",
    FRQ_glaettLageLegend: "Electrode position in cochlea",
    FRQ_glaettLageAussen: "Outer wall (Greenwood)",
    FRQ_glaettLageMitte: "Middle",
    FRQ_glaettLageInnen: "Inner wall (spiral ganglion)",
    FRQ_glaettGradLegend: "Smoothing curve",
    FRQ_glaettGradAus: "off",
    FRQ_glaettAchseLegend: "Computation space",
    FRQ_glaettAchseLog: "log frequency",
    FRQ_glaettAchseOrt: "Place space",
    ...
    FRQ_glaettRandfrei0: "0 electrodes",
    FRQ_glaettRandfrei1: "1 electrode",
    FRQ_glaettRandfrei2: "2 electrodes",
    FRQ_glaettRandfrei3: "3 electrodes",
    FRQ_glaettRandfrei4: "4 electrodes",
    FRQ_glaettRandfreiBasalLegend: "Edge exclusion (basal)",
    FRQ_glaettRandfreiBasal0: "0 electrodes",
    FRQ_glaettRandfreiBasal1: "1 electrode",
    FRQ_glaettRandfreiBasal2: "2 electrodes",
    FRQ_glaettRandfreiBasal3: "3 electrodes",
    FRQ_glaettRandfreiBasal4: "4 electrodes",
    ...
    FRQ_bandLageInnen:  "inner wall (Stakhovskaya, SG)",
    FRQ_bandVerfAbf: "sABF",
    FRQ_bandRandLegend: "Edge adjustment",
    FRQ_bandRandMit: "With adjustment (patent-faithful)",
    FRQ_bandRandOhne: "Without adjustment",
    FRQ_bandAbfSchApLegend: "Zone threshold apical",
    FRQ_bandAbfSchBaLegend: "Zone threshold basal",
    FRQ_bandAbfSchAussen: "outermost only",
    FRQ_bandAbfSchStd: "(default)",
    FRQ_bandEmpfAbfTooSmall: "ABF cannot be applied to the current measurement: the tonotopic middle range contains fewer than two electrodes. Please choose a different calculation method.",
    FRQ_bandTopoLegend: "Band topology",
    FRQ_bandTopoNahtlos: "Bands seamless",
    FRQ_bandTopoUeber: "Band overlap",
    FRQ_bandTopoLuecke: "Band gaps",
    FRQ_bandOptimierenLegend: "Boundary setting",
    FRQ_bandOptOptimiert: "Optimized",
    FRQ_bandOptKlassisch: "Classic",
    FRQ_bandZielLegend: "Optimization target",
    FRQ_bandZielMinimax: "Smallest outlier",
    FRQ_bandZielSumme: "Smallest total error",
    FRQ_bandRandvLegend: "Edge behaviour",
    FRQ_bandRandvAbschneiden: "clip at wall",
    FRQ_bandRandvTreffen: "meet the wall",
    FRQ_bandRandvLuecke: "allow gap",
    FRQ_bandRandvFrei: "set freely",
    ...
    FRQ_bandStumm: "Muted — exclusion before band calculation recommended",
    FRQ_bandEmpfColTarget: "Target frequency",
    ...
    FRQ_bandAusgangFallGlatt: "(Curve not smoothed, falls back to \"measured\")",
    FRQ_bandAusgangFallGem: "(Curve unmeasured, falls back to \"nominal frequency\")",
    FRQ_bandEmpfRatingNoise: "within noise",
    FRQ_bandEmpfRatingSlight: "slightly off",
    FRQ_bandEmpfRatingClear: "clearly off",
    FRQ_bandTipHeard: "heard",
    ...
    FRQ_bandCbfMitteZugStark: "Strong",
    ...
    plSpeedBusyTooltip: "Playback speed is calculating",
    ...
    STB_noElMsg: "No common active electrodes found.",
    LTZ_prereqHint: "First run the electrode loudness and stereo balance measurements for both sides.",
    ...
    tabSprachtest: "Speech test",
    stTitle: "Speech test — speech understanding in noise",
    stInstruction: "You will hear sentences with constant background noise. The sentences vary in loudness — don't let that discourage you; you often won't catch the whole sentence. In each column, pick the word you heard; no selection means \"not understood\".",
    stTrainHint: "A few practice sentences run before the measurement and are not scored.",
    ...
    stResCourseExplain: "",
    stResScatterTitle: "Scatter: SNR vs. words understood",
    stResScatterNote: "Supplementary view, not a clinical OLSA standard.",
    stResScatterExplain: "",
    ...
    optLR: "L → R",
    optRL: "R → L",
    STB_title: "Loudness comparison left/right",
    STB_maturityHint: "This test works in principle, but will certainly still be reworked.",
    ...
    STB_resNote: "The recommended global value (mean) is automatically entered above as the stereo balance offset.",
    STB_balEqual: "Sides almost equally loud",
    STB_rightLouder: "Boost left or attenuate right",
    STB_leftLouder: "Boost right or attenuate left",
    STB_thHz1: "Hz left",
    STB_thHz2: "Hz right",
    STB_thMeaning: "Meaning",
    STB_meaningRight: "Right is louder",
    STB_meaningLeft: "Left is louder",
    ...
    tonePopupApplySTB: "Apply stereo balance",
    ...
    plSourceLabel: "Category:",
    plNetSourceLabel: "Source:",
    plNetOnline: "online",
    plNetOffline: "offline",
    plSrcMusic: "♪ Music",
    ...
    plMusicAxisVocal: "Vocals",
    plMusicAxisArtist: "Artist",
    plMusicAxisComposer: "Composer",
    plMusicAxisAlbum: "Album",
    plMusicVocal_y: "with vocals",
    plMusicVocal_n: "instrumental",
    plMusicSourceLocalSuffix: "(local)",
    plMusicSourceLocalFiles: "Single tracks",
    plMusicGenre_westernart: "Western art music",
    plMusicGenre_hiphop: "Hip-Hop",
    plMusicGenre_rap: "Rap",
    plMusicGenre_electronica: "Electronica",
    plMusicGenre_romantic: "Romantic",
    plMusicGenre_baroque: "Baroque",
    plMusicGenre_classical: "Classical",
    ...
    plMusicGenre_mondernist: "Modernist",
    plAxisAll: "(any)",
    plAxisNone: "(without {axis})",
    plAxisAny: "(only with {axis})",
    ...
    plBookAxisAuthor: "Author",
    plBookAxisReader: "Reader",
    plBookAxisEpoch: "Era",
    plBookAxisLength: "Length",
    plBookAxisText: "Text source",
    plBookAxisGender: "Gender",
    plBookAxisDialekt: "Dialect",
    plBookAxisSource: "Source",
    plBookSource_upload: "Upload",
    plBookAxisSynthetic: "Voice",
    plBookEpoch_antike: "Antiquity",
    plBookEpoch_mittelalter: "Middle Ages",
    plBookEpoch_c16: "16th century",
    plBookEpoch_c17: "17th century",
    plBookEpoch_c18: "18th century",
    plBookEpoch_c19: "19th century",
    plBookEpoch_c20: "20th century",
    plBookEpoch_c21: "21st century",
    plBookLength_very_short: "very short (under 1 h)",
    plBookLength_short: "short (1–3 h)",
    plBookLength_medium: "medium (3–8 h)",
    plBookLength_long: "long (8–20 h)",
    plBookLength_very_long: "very long (over 20 h)",
    plBookGenre_action_adventure: "Action & Adventure",
    plBookGenre_action_adventure_fiction: "Action & Adventure Fiction",
    plBookGenre_american_standard_version: "American Standard Version",
    plBookGenre_ancient: "Ancient",
    plBookGenre_animals: "Animals",
    plBookGenre_animals_nature: "Animals & Nature",
    plBookGenre_anthologies: "Anthologies",
    plBookGenre_art_design_architecture: "Art, Design & Architecture",
    plBookGenre_arts: "Arts",
    plBookGenre_astronomy_physics_mechanics: "Astronomy, Physics & Mechanics",
    plBookGenre_atheism_agnosticism: "Atheism & Agnosticism",
    plBookGenre_ballads: "Ballads",
    plBookGenre_bibles: "Bibles",
    plBookGenre_biography: "Biography",
    plBookGenre_biography_autobiography: "Biography & Autobiography",
    plBookGenre_business_economics: "Business & Economics",
    plBookGenre_chemistry: "Chemistry",
    plBookGenre_children_s_fiction: "Children's Fiction",
    plBookGenre_children_s_non_fiction: "Children's Non-fiction",
    plBookGenre_christian_fiction: "Christian Fiction",
    plBookGenre_christianity_biographies: "Christianity - Biographies",
    plBookGenre_christianity_commentary: "Christianity - Commentary",
    plBookGenre_christianity_other: "Christianity - Other",
    plBookGenre_classics_greek_latin_antiquity: "Classics (Greek & Latin Antiquity)",
    plBookGenre_comedy: "Comedy",
    plBookGenre_contemporary: "Contemporary",
    plBookGenre_cooking: "Cooking",
    plBookGenre_crafts_hobbies: "Crafts & Hobbies",
    plBookGenre_crime_mystery_fiction: "Crime & Mystery Fiction",
    plBookGenre_culture_heritage_fiction: "Culture & Heritage Fiction",
    plBookGenre_detective_fiction: "Detective Fiction",
    plBookGenre_douay_rheims_version: "Douay-Rheims Version",
    plBookGenre_drama: "Drama",
    plBookGenre_dramatic_readings: "Dramatic Readings",
    plBookGenre_early_modern: "Early Modern",
    plBookGenre_earth_sciences: "Earth Sciences",
    plBookGenre_education: "Education",
    plBookGenre_elegies_odes: "Elegies & Odes",
    plBookGenre_epics: "Epics",
    plBookGenre_epistolary_fiction: "Epistolary Fiction",
    plBookGenre_erotica: "Erotica",
    plBookGenre_essays: "Essays",
    plBookGenre_essays_short_works: "Essays & Short Works",
    plBookGenre_exploration: "Exploration",
    plBookGenre_family: "Family",
    plBookGenre_family_relationships: "Family & Relationships",
    plBookGenre_family_life: "Family Life",
    plBookGenre_fantastic_fiction: "Fantastic Fiction",
    plBookGenre_fantasy_fiction: "Fantasy Fiction",
    plBookGenre_fictional_biographies_memoirs: "Fictional Biographies & Memoirs",
    plBookGenre_free_verse: "Free Verse",
    plBookGenre_games: "Games",
    plBookGenre_gardening: "Gardening",
    plBookGenre_general: "General",
    plBookGenre_general_fiction: "General Fiction",
    plBookGenre_gothic_fiction: "Gothic Fiction",
    plBookGenre_health_fitness: "Health & Fitness",
    plBookGenre_historical: "Historical",
    plBookGenre_historical_fiction: "Historical Fiction",
    plBookGenre_history: "History",
    plBookGenre_horror_supernatural_fiction: "Horror & Supernatural Fiction",
    plBookGenre_house_home: "House & Home",
    plBookGenre_humor: "Humor",
    plBookGenre_humorous_fiction: "Humorous Fiction",
    plBookGenre_king_james_version: "King James Version",
    plBookGenre_language_learning: "Language learning",
    plBookGenre_law: "Law",
    plBookGenre_letters: "Letters",
    plBookGenre_life_sciences: "Life Sciences",
    plBookGenre_literary_collections: "Literary Collections",
    plBookGenre_literary_criticism: "Literary Criticism",
    plBookGenre_literary_fiction: "Literary Fiction",
    plBookGenre_lyric: "Lyric",
    plBookGenre_mathematics: "Mathematics",
    plBookGenre_medical: "Medical",
    plBookGenre_medieval: "Medieval",
    plBookGenre_memoirs: "Memoirs",
    plBookGenre_middle_ages_middle_history: "Middle Ages/Middle History",
    plBookGenre_modern: "Modern",
    plBookGenre_modern_19th_c: "Modern (19th C)",
    plBookGenre_modern_20th_c: "Modern (20th C)",
    plBookGenre_multi_version_weekly_and_fortnightly_poetry: "Multi-version (Weekly and Fortnightly poetry)",
    plBookGenre_music: "Music",
    plBookGenre_myths_legends_fairy_tales: "Myths, Legends & Fairy Tales",
    plBookGenre_narratives: "Narratives",
    plBookGenre_nature: "Nature",
    plBookGenre_nature_animal_fiction: "Nature & Animal Fiction",
    plBookGenre_nautical_marine_fiction: "Nautical & Marine Fiction",
    plBookGenre_other_religions: "Other religions",
    plBookGenre_performing_arts: "Performing Arts",
    plBookGenre_periodicals_magazines: "Periodicals & Magazines",
    plBookGenre_philosophy: "Philosophy",
    plBookGenre_plays: "Plays",
    plBookGenre_poetry: "Poetry",
    plBookGenre_political_science: "Political Science",
    plBookGenre_psychology: "Psychology",
    plBookGenre_reference: "Reference",
    plBookGenre_religion: "Religion",
    plBookGenre_religious_fiction: "Religious Fiction",
    plBookGenre_romance: "Romance",
    plBookGenre_sagas: "Sagas",
    plBookGenre_satire: "Satire",
    plBookGenre_school: "School",
    plBookGenre_science: "Science",
    plBookGenre_science_fiction: "Science Fiction",
    plBookGenre_self_help: "Self-Help",
    plBookGenre_short_stories: "Short Stories",
    plBookGenre_short_non_fiction: "Short non-fiction",
    plBookGenre_short_works: "Short works",
    plBookGenre_social_science_culture_anthropology: "Social Science (Culture & Anthropology)",
    plBookGenre_sonnets: "Sonnets",
    plBookGenre_sports_recreation: "Sports & Recreation",
    plBookGenre_sports_fiction: "Sports Fiction",
    plBookGenre_suspense_espionage_political_thrillers: "Suspense, Espionage, Political & Thrillers",
    plBookGenre_technology_engineering: "Technology & Engineering",
    plBookGenre_tragedy: "Tragedy",
    plBookGenre_transportation: "Transportation",
    plBookGenre_travel_geography: "Travel & Geography",
    plBookGenre_travel_fiction: "Travel Fiction",
    plBookGenre_true_crime: "True Crime",
    plBookGenre_war_military: "War & Military",
    plBookGenre_war_military_fiction: "War & Military Fiction",
    plBookGenre_westerns: "Westerns",
    plBookGenre_weymouth_new_testament: "Weymouth New Testament",
    plBookGenre_world_english_bible: "World English Bible",
    plBookGenre_writing_linguistics: "Writing & Linguistics",
    ...
    plBookGender_m: "male",
    plBookGender_w: "female",
    plBookSynthetic_y: "AI voice",
    plBookSynthetic_n: "Human",
    plBookSearchLabel: "Search:",
    plBookSearchPlaceholder: "Title or author …",
