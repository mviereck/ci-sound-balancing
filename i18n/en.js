...
Object.assign(L.en, {
    ...
    lvTabDesc: "Vertical bars per electrode. Select an electrode by clicking to edit. Adjust with arrow keys ↑/↓ (±0.5 dB, Shift = ±0.1 dB). ←/→ switches between electrodes.",
    lvTabShowLabel: "Show:",
    lvTabSrcSlider: "Sliders",
    lvTabSrcMeas: "Measurement",
    lvTabSrcCurves: "Curves",
    lvTabReset: "Reset manual values to 0",
    lvTabElLabel: "Electrode",
    lvTabVlLabel: "Value",
    lvTabKeyHint: "Tip: Left/right arrow keys switch electrodes, up/down change the value. Use Shift for a smaller step.",
    lvTabWarpHint:
    ...
    lvTabVarLines: "comparison lines",
    lvTabAbsNotAvailable: "Absolute mode requires MCL values. Enter them in the Implant tab.",
    lvPreset: "Preset:",
