...
Object.assign(L.en, {
    ...
    FRQ_glaettIntro: "<p style=\"margin:0 0 8px\">Reproducing the exact measured values as closely as possible can lead to an uneven distribution of frequency bands. The curves offered here attempt to derive a plausible, smooth progression from the measured data.</p><ul style=\"margin:0 0 8px;padding-left:1.4em\"><li>Check whether one of the curves comes close to your measurement. The coloured green/amber/red dots indicate how well it fits.</li><li>The T-shaped residual bars show the measurement uncertainty; the better the curve runs through the residuals, the better it matches your measurements.</li><li>Electrodes marked as problematic, e.g. noisy, may deviate substantially.</li></ul><p style=\"margin:0\">The two place-affine methods are particularly recommended. They estimate the actual position of the implant in the cochlea from the measured values and adjust the frequency shift accordingly.</p>",
