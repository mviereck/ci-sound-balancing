...
Object.assign(L.en, {
    ...
    FRQ_resultsColBand: "Band recommendation",
    FRQ_bandOverlapCellTip: "Crossing measurement - no band boundary computable",
    FRQ_bandOverlapNote: "No frequency bands can be computed for the current measurement: electrodes {els} have crossing perceived frequencies, so no unambiguous band sequence results.",
    FRQ_bandExplain: "Band recommendation. The suggested frequency bands are computed from the perceived centre frequencies: the boundary between two neighbouring electrodes lies at the logarithmic mean of their frequencies. This is a manufacturer-neutral approximation - depending on implant and coding strategy, other band distributions are possible (e.g. logarithmic, linear-logarithmic or anatomy-based).",
    FRQ_randHinweisIntro: "The lower limit of the overall frequency range is usually set considerably lower by the manufacturers than the logarithmic computation yields, so the hearing spectrum is larger. Towards the top, by contrast, the spectrum is slightly narrowed. Known deviation from logarithmic computation:",
    FRQ_randCol1: "lower",
    FRQ_randCol2: "upper",
    FRQ_randHinweisOutro: "The additional span towards the bottom should be used when re-setting the frequencies. Towards the top, the computed value from the table can be adopted.",
    FRQ_randBlock2Intro: "Applied to the band widths given above, this would mean:",
