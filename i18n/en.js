...
Object.assign(L.en, {
    ...
    fmrThEl: "Electrode",
    fmrThVarHz: "Freq. {side} setting (Hz)",
    fmrThRefHz: "Freq. {side} perception (Hz)",
    fmrSidesDesc1: "Reference side: {ref} · Target side: {var}",
    fmrSidesDesc2: "During the measurement, the frequency on the reference side was shifted until both sides sounded the same. The table shows the necessary change for the target side {var} so that it sounds like the reference side {ref}.",
    fmrThDiffHz: "Diff. (Hz)",
    fmrThDiffCent: "Diff. (cent)",
    fmrThConv:          "Convergence width (ct)",
    fmrThConvTip:       "Half-span of the last 6 reversals of the staircase, averaged across all runs. Low = narrow convergence width within a run, high = uncertain perception.",
    fmrThRunSpread:     "Run dispersion (ct)",
    fmrThRunSpreadTip:  "Standard deviation of the match points between individual runs. Large value = the runs land at different distances apart — indication of residual bias from starting values or fluctuating perception. Requires ≥2 runs.",
    fmrThResiduum:      "Residual (ct)",
    fmrThResiduumTip:   "Overall measurement uncertainty, quadratically combined from convergence width (within a run) and run dispersion (between runs). Traffic light: ≤10 ct green, 11–25 ct yellow, >25 ct red.",
    fmrThStatus: "Status",
    fmrStatusOk: "✓ converged",
    fmrStatusFair: "dispersion",
    fmrStatusWide: "strong dispersion",
    fmrStatusUnstable: "unstable",
    fmrStatusAborted: "aborted",
    fmrStatusNotPerc: "✗ not perceivable",
    fmrStatusProvEarly:      "running · {n} comparisons",
    fmrStatusProvLate:       "in progress · {n} reversals",
    fmrProvisionalCount:     "{n} running",
    fmrStatusSliderEst:      "🎚 pre-estimate",
    fmrSliderEstimateCount:  "{n} pre-estimate(s)",
    fmrTipSliderEst:         "Pre-estimate",
    fmrProgressLabel:     "Progress of current measurement",
    fmrRunHint:           "The residual uncertainty of the measurement can only be reliably estimated after 2 complete test runs. With only one run, the run dispersion as a second source of error is missing — the uncertainty shown in the graph is therefore preliminary.",
    fmrQualEarly:         "First measurements are running ({n} of {t} electrodes). Values are preliminary, please complete the test to the end.",
    fmrQualPartial:       "Partially measured ({done} of {total} electrodes converged, mean residual uncertainty {res} cents). Values are roughly usable, the test should be completed for a reliable result.",
    fmrQualOk:            "Measurement complete (mean residual uncertainty {res} cents). Values are suitable as a reference for a FAT adjustment.",
    fmrQualOkWithNoisy:   "Measurement complete (mean residual uncertainty {res} cents). The following electrodes have significant residual uncertainty: {names}. Values usable, but be cautious when transferring them.",
    fmrTipNotPerc: "not perceivable",
    fmrTipResidual: "residual uncertainty",
    fmrChartHintAdaptive: "Actual line = programmed electrode frequency, target point = perceived match. ✓ = clean convergence, orange band = residual uncertainty (width = ±residual in cents), ✗ = not perceivable. Hollow blue circle = preliminary interim state (measurement still running); hollow circle with “?” = not enough data yet for an estimate.",
    fmrChartXLabel: "Frequency (cents relative to 1 kHz)",
    fmrChartYLabel: "Deviation (cents)",
    fmrLblIst: "Actual",
    fmrLblSoll: "Target",
    fmrChartHint: "Gray (dashed) line = actual frequency, as programmed in the implant. Black line = target frequency, at which the electrode is perceived according to the measurement. The arrow shows the necessary correction; the Y-axis shows its size in cents. Unmeasured electrodes: only actual line + circle. Excluded electrodes: only actual line + ✕.",
    fmrNoData: "No frequency matching results yet.",
    fmrClearAllBtnLabel: "🗑 Delete all frequency matching results",
    fmrClearSliderBtnLabel: "🗑 Delete fine-tuning values only",
    fmrClearAdaptiveBtnLabel: "🗑 Delete only adaptive results",
    fmrClearAllConfirm: "Delete all frequency matching results and track raw data (slider and adaptive)? This action cannot be undone.",
    fmrClearSliderConfirm: "Delete fine-tuning values?",
