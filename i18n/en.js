...
Object.assign(L.en, {
    ...
    lrBlockedSideUnknown:   "Please choose the hearing technology (and manufacturer if applicable) for both sides before starting the stereo balance test.",
    cfgHintBothAcoustic:
    ...
    lrNoElMsg: "No common active electrodes found.",
    ...
    lrNoResultsMsg: "No results yet. First run a measurement under “Measurements → Stereo balance”.",
    lrResTitle: "Results L/R comparison",
    ...
    lrClearBtnLabel: "🗑 Delete results",
    lrResNote: "The recommended global value (mean) is automatically entered above as the stereo balance offset.",
    lrBalEqual: "Sides almost equally loud",
