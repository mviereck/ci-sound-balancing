...
Object.assign(L.de, {
    ...
    plNoiseCatAll: "(alle)",
    plNoiseFile: "Audiodatei (MP3, WAV, FLAC, OGG, M4A, MP4)",
    plNoiseLocalAdd: "+ Lokalen Ordner laden",
    plNoiseLocalHint: "Audiodateien aus einem lokalen Ordner als Geräusch-Sammlung hinzufügen (nur diese Sitzung).",
    plNoiseLocalNone: "Keine lokalen Ordner geladen.",
    ...
    plBookFile: "Einzeldatei laden",
    plBookUploadHint: "Ordner mit nummerierten Kapitel-Dateien wählen (z. B. 01_*.mp3). Oder eine Einzeldatei.",
