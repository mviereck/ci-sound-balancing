...
Object.assign(L.de, {
    ...
    FRQ_resultsColBand: "Bandempfehlung",
    FRQ_bandOverlapCellTip: "Überkreuzende Messung – keine Bandgrenze berechenbar",
    FRQ_bandOverlapNote: "Für die aktuelle Messlage können keine Frequenzbänder berechnet werden: Die Elektroden {els} weisen überkreuzende wahrgenommene Frequenzen auf, sodass sich keine eindeutige Bandfolge ergibt.",
    FRQ_bandExplain: "Bandempfehlung. Die vorgeschlagenen Frequenzbänder werden aus den wahrgenommenen Mittenfrequenzen berechnet: Die Grenze zwischen zwei benachbarten Elektroden liegt jeweils auf der logarithmischen Mitte ihrer Frequenzen. Dies ist ein herstellerneutraler Näherungsvorschlag – je nach Implantat und Kodierungsstrategie sind andere Bandverteilungen möglich (z. B. logarithmisch, linear-logarithmisch oder anatomiebasiert).",
    FRQ_randHinweisIntro: "Die untere Grenze des Gesamt-Frequenzbereiches ist in der Regel von den Herstellern deutlich tiefer angesetzt als es die logarithmische Berechnung ergibt, das Hörspektrum ist also größer. Nach oben hingegen ist das Spektrum etwas eingeengt. Bekannte Abweichung von logarithmischer Berechnung:",
    FRQ_randCol1: "unten",
    FRQ_randCol2: "oben",
    FRQ_randHinweisOutro: "Die zusätzliche Spanne nach unten sollte bei Neueinstellung der Frequenzen ausgenutzt werden. Nach oben kann der berechnete Wert aus der Tabelle übernommen werden.",
    FRQ_randBlock2Intro: "Übertragen auf die oben genannten Bandbreiten hieße das:",
