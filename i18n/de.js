...
Object.assign(L.de, {
    ...
    toneRichCiHADesc:        "Variante zu harmonisch: Anschwingen 600 ms (statt 250), AM-Tiefe 18 % (statt 8). Testet ob längeres Anschwingen + kräftigere Modulation die AGC-Welle reduziert.",
    toneRichCiHS:            "CI-Test AM-langsam",
    toneRichCiHSDesc:        "Variante zu harmonisch: AM bei 2,7 Hz / 25 % Tiefe, Anschwingen 500 ms. AM in der vom Nutzer beobachteten Wellenfrequenz — testet ob das AGC die Schleife synchron mitführt statt zum Pumpen anregt.",
    toneRichCiHF:            "CI-Test flach (Diagnose)",
    toneRichCiHFDesc:        "Variante zu harmonisch: ohne AM (amDepth = 0), Anschwingen 500 ms. Diagnose-Test: bleibt die Welle bei Null-Modulation, ist die AGC selbst Quelle (Eigenresonanz). Verschwindet sie, war unsere AM die Ursache.",
