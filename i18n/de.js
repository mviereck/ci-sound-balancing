...
Object.assign(L.de, {
    ...
    toneRichTone: "Reicher Komplexton (8 Harmonische, Vibrato 5 Hz, Atem-AM 3 Hz)",
    ...
    toneIRN: "Iterated Rippled Noise (16 Iterationen)",
    ...
    toneRichCiHDesc:         "Grundton + 4 ganzzahlige Obertöne (1, 1/2, 1/3, 1/4, 1/5). Klassisch harmonisch.",
    toneRichCiB:             "CI-Test inharmonisch",
    toneRichCiBDesc:         "Wie harmonisch, aber Partial-Frequenzen leicht verstimmt (≈ Glocken-Anmutung). Gibt der CI-Filterbank mehr Streuung ohne Tonhöhen-Verlust.",
    toneRichCiHA:            "CI-Test Attack-stark",
    toneRichCiHADesc:        "Variante zu harmonisch: Anschwingen 600 ms (statt 250), AM-Tiefe 18 % (statt 8). Längeres Anschwingen + kräftigere Modulation — bei Martin schlechter als CiH, könnte bei anderen CIs anders ausfallen.",
    toneRichCiHS:            "CI-Test AM-langsam",
    toneRichCiHSDesc:        "Variante zu harmonisch: AM bei 2,7 Hz / 25 % Tiefe, Anschwingen 500 ms. AM in der bei Martin beobachteten AGC-Wellenfrequenz — regte bei ihm die Welle stark an. Andere CIs mit anderer AGC-Konstante können anders reagieren.",
    toneRichCiHF:            "CI-Test flach",
    toneRichCiHFDesc:        "Variante zu harmonisch: ohne AM (amDepth = 0), Anschwingen 500 ms, Vibrato bleibt. Bei Martin der ruhigste Klang — AGC bekommt keine Modulation zum Hinterherregeln.",
    toneRichCiP:             "CI-Test pur",
    toneRichCiPDesc:         "Maximalreduktion: kein AM, kein Vibrato, Anschwingen 250 ms. Diagnose ob Vibrato (Frequenz-Modulation) bei manchen CIs die Welle zusätzlich speist. Tonhöhe stationär, keine Modulationsspur.",
    toneRichCiBF:            "CI-Test inharmonisch flach",
    toneRichCiBFDesc:        "Inharmonisch (≈ Glocken-Anmutung) ohne AM. Vergleicht Inharmonik-Wirkung isoliert gegen Vollvariante CiB — zeigt, ob bei rauherem Spektrum die AM-Welle der einzige Welle-Treiber ist.",
