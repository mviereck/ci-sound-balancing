...
Object.assign(L.de, {
    ...
    introDesc:
      "Dieses Tool hilft CI-Trägern, die wahrgenommene Lautstärke ihrer Elektroden systematisch zu vergleichen und eine individuelle Korrekturkurve zu erstellen. Ziel ist es, exakt gleiche Lautstärke aller Elektroden einzustellen – die grundlegende Basis für gutes Hören mit CI. Diese Einstellung ist optimal für Musik und Naturgeräusche. Anpassungen für Sprachverständnis oder Effekte wie Baßverstärkung sind ebenfalls möglich und können live getestet werden.<br>Außerdem kann die Tonhöhenwahrnehmung gemessen werden, vergleichend das linke und das rechte Ohr. Auf Basis der gemessenen Frequenzen kann der Audiologe das CI so anpassen, daß die Tonhöhen links und rechts gleich klingen.",
    introWhat: "Wie ist der Ablauf?",
    introFlowDesc:
      "<b>1. Seitenwahl</b> – Wählen Sie oben zwischen den Seiten LINKS und RECHTS.<br><b>2. Reiter Implantat</b> – Tragen Sie auf CI Seite(n) Ihren Hersteller ein. Falls bekannt, korrigieren Sie die Frequenzbandeinträge pro Elektrode. Standardwerte sind voreingestellt. <b>Wichtig:</b> Deaktivierte Elektroden müssen in Spalte „Aktiv” angehakt werden.<br><b>3. Reiter Implantat: Andere Seite</b> – Machen Sie auch dort Einträge. Wenn Sie dort kein CI tragen, geben Sie an, wie Sie dort hören (Normal, schwerhörig, taub).<br><b>4. Lautstärke</b> – Stellen Sie die Lautstärke ihres PC oder Smartphone auf gefühlt 3/4 ein. Nicht leise, noch nicht unangenehm laut.<br><b>5. Messung</b> – Wählen Sie die CI Seite und starten Sie eine Testreihe in „Messungen” → „Elektrodenlautstärke”. Das Tool spielt Tonpaare ab; Sie stellen ein, bis beide gleich laut klingen. Bei 2 CI machen Sie die Messung für beide Seiten.<br><b>6. Player</b> – Laden Sie eine Musikdatei und hören Sie den Unterschied mit und ohne Korrektur.<br><b>7. Stereo-Balance</b> – In „Messungen“ → „Stereo-Balance“ können Sie den Lautstärkenunterschied zwischen links und rechts ausgleichen.<br><b>8. Latenz</b> – In „Messungen“ → „Latenz“ können Sie, falls vorhanden, einen Zeitunterschied zwischen links und rechts korrigieren.<br><b>9. Frequenzabgleich</b> – In „Messungen“ → „Frequenzabgleich“ können Sie die Tonhöhen messen, so daß sie links und rechts hoch oder tief gleich klingen.<br><b>10. Player</b> – Testen Sie wieder im Player. Dort können Sie auch „Frequenz-Warping“ aktivieren, falls Sie einen Frequenzabgleich-Test gemacht haben.<br><b>11. Kurven und Schieber</b> – In den Reitern „Kurven“ und „Schieber“ können Sie die Elektrodenlautstärke weiter justieren, z. B. Optimierung für Sprache. Sie können Einstellungsveränderungen live hören, wenn Sie gleichzeitig ein Audio abspielen.",
    introWarn:
    ...
    LTZ_BTWarning: "Für diesen Test brauchen Sie Kopfhörer. Bluetooth erzeugt eigene erhebliche Latenzen. Verwenden Sie Bluetooth nur, wenn Sie gezielt Bluetooth-Latenz messen wollen.",
    ...
    no: "nein",
    introAudioDesc:
      "Die Ergebnisse können im Reiter Laden/Speichern ausgedruckt werden. Der Ausdruck enthält die Meßergebnisse, Ihre gewünschten Korrekturen und die resultierenden Equalizer-Werte.",
    ...
    implValidatePrefixL1: "Fehler:",
    implValidatePrefixL2: "Achtung:",
    implValidatePrefixL3: "Auffälligkeit:",
    implValidatePrefixL4: "Hinweis:",
    ...
    implValidateInfoAllActive: "Keine Elektrode ist als inaktiv markiert. Bitte prüfen Sie, ob das korrekt ist.",
    implValidateFspNone: "Keine Elektrode für die Feinstruktur ({strat}) markiert. Bei {strat} werden gewöhnlich die apikalen Elektroden über die Feinstruktur gesteuert — bitte prüfen.",
    implValidateFspOnlyE1: "Nur E1 für die Feinstruktur ({strat}) markiert. Bei {strat} sind gewöhnlich mehrere apikale Elektroden beteiligt — bitte prüfen, ob das korrekt ist.",
    implValidateFspGap: "Feinstruktur-Elektroden nicht lückenlos ab E1 markiert (E{gap} übersprungen). Üblich ist eine durchgehende Reihe ab E1 — bitte prüfen.",
    implValidateInfoUpperEmpty: "{label}-Werte nicht eingetragen — {unit}-Werte im Ausdruck nicht berechenbar, nur dB. Im Reiter Schieber keine Absolut-Werte anzeigbar.",
    ...
    implValidateInfoCodingUnknown: "Keine Kodierungsstrategie angegeben. Bitte holen Sie das nach.",
    sweep: "▶ Sweep",
    stop: "■ Stopp",
    ...
    ELL_distWeightLabel: "Gewichtung entfernter Paarmessungen:",
    ELL_dwVoll:   "Voll",
    ELL_dwMittel: "Mittel",
    ELL_dwGering: "Gering",
    ...
    plSourceLabel: "Kategorie:",
    plNetSourceLabel: "Quelle:",
    plNetOnline: "online",
    ...
    plNoiseAxisSource: "Quelle",
    plNoiseAxisKind: "Art",
    plNoiseAxisSpectrum: "Spektrum",
    plNoiseAxisStationary: "Zeitverlauf",
    plNoiseAxisLoopSafe: "Loopbar",
    plNoiseKind_rauschen_weiss: "Weißes Rauschen",
    plNoiseKind_rauschen_rosa: "Rosa Rauschen",
    plNoiseKind_rauschen_ccitt: "CCITT-Rauschen",
    plNoiseKind_rauschen_ssn: "Sprachsimulationsrauschen",
    plNoiseKind_babble: "Stimmengewirr",
    plNoiseKind_cafe: "Café",
    plNoiseKind_verkehr: "Verkehr",
    plNoiseKind_wetter: "Wetter",
    plNoiseKind_tier: "Tier",
    plNoiseKind_haushalt: "Haushalt",
    plNoiseKind_industrie: "Industrie",
    plNoiseKind_crowd: "Menschenmenge",
    plNoiseKind_ambient: "Umgebung",
    plNoiseKind_test_ton: "Testton",
    plNoiseSpectrum_broadband: "Breitband",
    plNoiseSpectrum_lowpass: "Tieflastig",
    plNoiseSpectrum_highpass: "Hochlastig",
    plNoiseSpectrum_bandpass: "Bandbegrenzt",
    plNoiseSpectrum_tonal: "Tonal",
    plNoiseStationary_y: "gleichmäßig",
    plNoiseStationary_n: "wechselnd",
    plNoiseLoopSafe_y: "nahtlos loopbar",
    plNoiseLoopSafe_n: "nicht loopbar",
    ...
    plMusicCatAll: "(alle)",
    plMusicAxisSource: "Quelle",
    plMusicAxisGenre: "Genre",
    plMusicAxisVocal: "Gesang",
    plMusicAxisArtist: "Künstler",
    plMusicAxisComposer: "Komponist",
    plMusicAxisAlbum: "Album",
    plMusicVocal_y: "mit Gesang",
    plMusicVocal_n: "instrumental",
    plMusicSourceLocalSuffix: "(lokal)",
    plMusicSourceLocalFiles: "Einzelstücke",
    plMusicGenre_westernart: "Klassik (abendländisch)",
    plMusicGenre_hiphop: "Hip-Hop",
    plMusicGenre_rap: "Rap",
    plMusicGenre_electronica: "Electronica",
    plMusicGenre_romantic: "Romantik",
    plMusicGenre_baroque: "Barock",
    plMusicGenre_classical: "Klassik",
    ...
    plMusicGenre_experimental: "Experimentell",
    ...
    plAxisAll: "(beliebig)",
    plAxisNone: "(ohne {axis})",
    plAxisAny: "(nur mit {axis})",
    ...
    plBookAxisReader: "Sprecher",
    plBookAxisEpoch: "Epoche",
    plBookAxisLength: "Länge",
    plBookAxisText: "Textquelle",
    plBookAxisGender: "Geschlecht",
    plBookAxisDialekt: "Dialekt",
    plBookAxisSource: "Quelle",
    plBookSource_upload: "Upload",
    plBookAxisSynthetic: "Stimme",
    plBookEpoch_antike: "Antike",
    plBookEpoch_mittelalter: "Mittelalter",
    plBookEpoch_c16: "16. Jahrhundert",
    plBookEpoch_c17: "17. Jahrhundert",
    plBookEpoch_c18: "18. Jahrhundert",
    plBookEpoch_c19: "19. Jahrhundert",
    plBookEpoch_c20: "20. Jahrhundert",
    plBookEpoch_c21: "21. Jahrhundert",
    plBookLength_very_short: "sehr kurz (unter 1 h)",
    plBookLength_short: "kurz (1–3 h)",
    plBookLength_medium: "mittel (3–8 h)",
    plBookLength_long: "lang (8–20 h)",
    plBookLength_very_long: "sehr lang (über 20 h)",
    plBookGenre_action_adventure: "Action & Abenteuer",
    plBookGenre_action_adventure_fiction: "Action- & Abenteuerroman",
    plBookGenre_american_standard_version: "American Standard Version (Bibel)",
    plBookGenre_ancient: "Antike",
    plBookGenre_animals: "Tiere",
    plBookGenre_animals_nature: "Tiere & Natur",
    plBookGenre_anthologies: "Anthologien",
    plBookGenre_art_design_architecture: "Kunst, Design & Architektur",
    plBookGenre_arts: "Künste",
    plBookGenre_astronomy_physics_mechanics: "Astronomie, Physik & Mechanik",
    plBookGenre_atheism_agnosticism: "Atheismus & Agnostizismus",
    plBookGenre_ballads: "Balladen",
    plBookGenre_bibles: "Bibeln",
    plBookGenre_biography: "Biografie",
    plBookGenre_biography_autobiography: "Biografie & Autobiografie",
    plBookGenre_business_economics: "Wirtschaft & Ökonomie",
    plBookGenre_chemistry: "Chemie",
    plBookGenre_children_s_fiction: "Kinderliteratur",
    plBookGenre_children_s_non_fiction: "Kinder-Sachbuch",
    plBookGenre_christian_fiction: "Christliche Belletristik",
    plBookGenre_christianity_biographies: "Christentum – Biografien",
    plBookGenre_christianity_commentary: "Christentum – Kommentare",
    plBookGenre_christianity_other: "Christentum – Sonstiges",
    plBookGenre_classics_greek_latin_antiquity: "Klassiker (griech. & lat. Antike)",
    plBookGenre_comedy: "Komödie",
    plBookGenre_contemporary: "Zeitgenössisch",
    plBookGenre_cooking: "Kochen",
    plBookGenre_crafts_hobbies: "Handwerk & Hobbys",
    plBookGenre_crime_mystery_fiction: "Krimi & Mystery",
    plBookGenre_culture_heritage_fiction: "Kultur- & Heimatroman",
    plBookGenre_detective_fiction: "Detektivroman",
    plBookGenre_douay_rheims_version: "Douay-Rheims-Bibel",
    plBookGenre_drama: "Drama",
    plBookGenre_dramatic_readings: "Dramatische Lesungen",
    plBookGenre_early_modern: "Frühe Neuzeit",
    plBookGenre_earth_sciences: "Geowissenschaften",
    plBookGenre_education: "Bildung",
    plBookGenre_elegies_odes: "Elegien & Oden",
    plBookGenre_epics: "Epen",
    plBookGenre_epistolary_fiction: "Briefroman",
    plBookGenre_erotica: "Erotik",
    plBookGenre_essays: "Essays",
    plBookGenre_essays_short_works: "Essays & Kurzwerke",
    plBookGenre_exploration: "Entdeckung & Expedition",
    plBookGenre_family: "Familie",
    plBookGenre_family_relationships: "Familie & Beziehungen",
    plBookGenre_family_life: "Familienleben",
    plBookGenre_fantastic_fiction: "Phantastik",
    plBookGenre_fantasy_fiction: "Fantasy",
    plBookGenre_fictional_biographies_memoirs: "Fiktive Biografien & Memoiren",
    plBookGenre_free_verse: "Freie Verse",
    plBookGenre_games: "Spiele",
    plBookGenre_gardening: "Gartenbau",
    plBookGenre_general: "Allgemein",
    plBookGenre_general_fiction: "Allgemeine Belletristik",
    plBookGenre_gothic_fiction: "Schauerroman",
    plBookGenre_health_fitness: "Gesundheit & Fitness",
    plBookGenre_historical: "Historisch",
    plBookGenre_historical_fiction: "Historischer Roman",
    plBookGenre_history: "Geschichte",
    plBookGenre_horror_supernatural_fiction: "Horror & Übernatürliches",
    plBookGenre_house_home: "Haus & Heim",
    plBookGenre_humor: "Humor",
    plBookGenre_humorous_fiction: "Humoristische Belletristik",
    plBookGenre_king_james_version: "King-James-Bibel",
    plBookGenre_language_learning: "Sprachenlernen",
    plBookGenre_law: "Recht",
    plBookGenre_letters: "Briefe",
    plBookGenre_life_sciences: "Biowissenschaften",
    plBookGenre_literary_collections: "Literarische Sammlungen",
    plBookGenre_literary_criticism: "Literaturkritik",
    plBookGenre_literary_fiction: "Literarische Belletristik",
    plBookGenre_lyric: "Lyrik",
    plBookGenre_mathematics: "Mathematik",
    plBookGenre_medical: "Medizin",
    plBookGenre_medieval: "Mittelalterlich",
    plBookGenre_memoirs: "Memoiren",
    plBookGenre_middle_ages_middle_history: "Mittelalter",
    plBookGenre_modern: "Moderne",
    plBookGenre_modern_19th_c: "Moderne (19. Jh.)",
    plBookGenre_modern_20th_c: "Moderne (20. Jh.)",
    plBookGenre_multi_version_weekly_and_fortnightly_poetry: "Mehrfassungen (Wochen-/Halbmonats-Lyrik)",
    plBookGenre_music: "Musik",
    plBookGenre_myths_legends_fairy_tales: "Mythen, Sagen & Märchen",
    plBookGenre_narratives: "Erzählungen",
    plBookGenre_nature: "Natur",
    plBookGenre_nature_animal_fiction: "Natur- & Tierroman",
    plBookGenre_nautical_marine_fiction: "Seefahrtsroman",
    plBookGenre_other_religions: "Andere Religionen",
    plBookGenre_performing_arts: "Darstellende Künste",
    plBookGenre_periodicals_magazines: "Zeitschriften & Magazine",
    plBookGenre_philosophy: "Philosophie",
    plBookGenre_plays: "Theaterstücke",
    plBookGenre_poetry: "Lyrik",
    plBookGenre_political_science: "Politikwissenschaft",
    plBookGenre_psychology: "Psychologie",
    plBookGenre_reference: "Nachschlagewerke",
    plBookGenre_religion: "Religion",
    plBookGenre_religious_fiction: "Religiöse Belletristik",
    plBookGenre_romance: "Liebesroman",
    plBookGenre_sagas: "Sagas",
    plBookGenre_satire: "Satire",
    plBookGenre_school: "Schule",
    plBookGenre_science: "Wissenschaft",
    plBookGenre_science_fiction: "Science-Fiction",
    plBookGenre_self_help: "Ratgeber",
    plBookGenre_short_stories: "Kurzgeschichten",
    plBookGenre_short_non_fiction: "Kurzes Sachbuch",
    plBookGenre_short_works: "Kurzwerke",
    plBookGenre_social_science_culture_anthropology: "Sozialwissenschaft (Kultur & Anthropologie)",
    plBookGenre_sonnets: "Sonette",
    plBookGenre_sports_recreation: "Sport & Freizeit",
    plBookGenre_sports_fiction: "Sportroman",
    plBookGenre_suspense_espionage_political_thrillers: "Spannung, Spionage & Thriller",
    plBookGenre_technology_engineering: "Technik & Ingenieurwesen",
    plBookGenre_tragedy: "Tragödie",
    plBookGenre_transportation: "Verkehr & Transport",
    plBookGenre_travel_geography: "Reise & Geografie",
    plBookGenre_travel_fiction: "Reiseroman",
    plBookGenre_true_crime: "Wahre Verbrechen",
    plBookGenre_war_military: "Krieg & Militär",
    plBookGenre_war_military_fiction: "Kriegsroman",
    plBookGenre_westerns: "Western",
    plBookGenre_weymouth_new_testament: "Weymouth-Neues-Testament",
    plBookGenre_world_english_bible: "World English Bible",
    plBookGenre_writing_linguistics: "Schreiben & Linguistik",
    plBookGenre_young_s_literal_translation: "Young's Literal Translation",
    plBookAxisFiction: "Art",
    plBookFiction_y: "Belletristik",
    plBookFiction_n: "Sachbuch",
    plBookFiction_artikel: "Artikel",
    plBookGender_m: "männlich",
    plBookGender_w: "weiblich",
    plBookSynthetic_y: "KI-Stimme",
    plBookSynthetic_n: "Mensch",
    plBookSearchLabel: "Suche:",
    plBookSearchPlaceholder: "Titel oder Autor …",
    ...
    plTextFontSmaller: "Schrift kleiner",
    plTextFontLarger: "Schrift größer",
    plTextLineTighter: "Zeilen enger",
    plTextLineLooser: "Zeilen weiter",
    ...
    plReadShowText: "Text anzeigen",
    plReadFind: "Stelle finden",
    ...
    plAxisStyle:            "Aufnahme-Art",
    plAxisTestSet:          "Testsatz-Sammlung",
    plAxisAccent:           "Akzent",
    plAxisEmotion:          "Emotion",
    plAxisEmotion_neutral:   "neutral",
    plAxisEmotion_amused:    "amüsiert",
    plAxisEmotion_angry:     "wütend",
    plAxisEmotion_disgusted: "angewidert",
    plAxisEmotion_drunk:     "betrunken",
    plAxisEmotion_sleepy:    "schläfrig",
    plAxisEmotion_surprised: "überrascht",
    plAxisEmotion_whisper:   "flüsternd",
    plAxisGender_m:         "männlich",
    plAxisGender_w:         "weiblich",
    plAxisGender_u:         "unbekannt",
    plAxisGender_i:         "intersexuell",
    plAxisStyle_studio:     "Studio",
    plAxisStyle_narration:  "Vorgelesen",
    plAxisStyle_test:       "Sprachtest",
    plAxisStyle_emotional:  "Emotional",
    plAxisStyle_dialect:    "Dialekt",
    plAxisStyle_crowdsourced: "Alltag",
    ...
    audiologWarnEqOff: "Sämtliche Korrekturen sind im Player abgeschaltet (EQ aus). Dieser Ausdruck enthält deshalb keine Korrektureinstellungen. Vermutlich möchten Sie die Korrektur einschalten, bevor Sie exportieren.",
    audiologWarnMeasuredNoEQ: "Es liegen Elektrodenlautstärke-Ergebnisse vor, aber die Elektrodenlautstärke ist im Player nicht aktiviert. Dieser Ausdruck enthält deshalb keine Korrektur für Elektrodenlautstärke. Vermutlich möchten Sie Elektrodenlautstärke einschalten.",
    audiologWarnMeasuredNoWarp: "Es liegen Frequenzabgleich-Ergebnisse vor, aber das Frequenz-Warping ist im Player nicht aktiviert. Dieser Ausdruck enthält deshalb keine Frequenz-Einstellungswünsche. Vermutlich möchten Sie das Frequenz-Warping einschalten.",
    audiologWarnNhSim: "Die Simulation für Normalhörende ist aktiviert. Die hier angegebenen Werte bilden diese Simulation nach und werden auch als Einstellungswunsch so wiedergegeben. Das möchten Sie vermutlich nicht.",
    audiologWarnAcousticWarp: "Das Frequenz-Warping „{mode}“ verändert die Frequenzen auf einem Ohr ohne Cochlea-Implantat. Dort lässt sich keine Frequenz-Einstellung ins Implantat programmieren.",
    audiologWarnAcousticWarpFix: "Vermutlich möchten Sie die Einstellung „{ciSide}“.",
    ...
    tabFrequenzbaender: "Frequenzbänder",
    tabKurven: "Kurven",
    ...
    lblImplCoding: "Kodierungsstrategie:",
    implCodingUnknown: "unbekannt",
    ...
    FRQ_pianoDurchlaufTitle: "Durchlauf {x} fertig",
    FRQ_pianoDurchlaufMsg:   "Weiter mit dem nächsten Durchlauf?",
    FRQ_pianoRoundNext:      "Weiter",
    FRQ_pianoRoundFinish:    "Beenden",
    FRQ_pianoProgress:       "Elektrode {n} von {m} · Durchlauf {r}",
    ...
    FRQ_resultsColNominalHz: "Mitte geom. (arithm.)",
    FRQ_resultsColPerceivedHz: "Hz Wahrnehmung",
    FRQ_resultsSidesDescription1: "Auswertung Meßergebnisse für Seite {side}:",
    ...
    FRQ_resultsColRestspanne:    "Restspanne (ct)",
    ...
    FRQ_resultsStatusNotActive: "deaktiviert",
    ...
    FRQ_resultsStatusPianoCrossed:   "Meßergebnis überkreuzt",
    FRQ_resultsStatusPianoWide:      "Meßergebnis — Spanne zu breit",
    ...
    FRQ_resultsTipRestspanne: "Restspanne",
    ...
    FRQ_resultsChartHintPiano:      "Ist-Strich = programmierte Elektroden-Frequenz, Soll-Punkt = wahrgenommene Übereinstimmung. Schwarzer Balken/oranges Band = Residuum (Streuung über den Verlauf, asymmetrisch), blauer Balken = Restspanne (zuletzt erreichte Auflösung).",
    // --- Frequenzgraph-Legende (Architektur §8) ---
    FRQ_legLegende: "Legende:",
    // Element-Namen (Spalte 1)
    FRQ_legElement_strichGrau:    "Senkrechter Strich",
    FRQ_legElement_strichSchwarz: "Senkrechter Strich",
    FRQ_legElement_pfeil:         "Pfeil",
    FRQ_legElement_punkt:         "Punkt",
    FRQ_legElement_band:          "Band",
    FRQ_legElement_querbalken:    "Querbalken",
    FRQ_legElement_querbalkBlau:  "Querbalken",
    FRQ_legElement_kurve:         "Kurve",
    FRQ_legElement_flaeche:       "Fläche",
    // Farb-Woerter (Spalte 2)
    FRQ_legFarbe_hellgrau:     "hellgrau",
    FRQ_legFarbe_schwarz:      "schwarz",
    FRQ_legFarbe_orange:       "orange",
    FRQ_legFarbe_blau:         "blau",
    FRQ_legFarbe_gruen:        "grün",
    FRQ_legFarbe_hellblau:     "hellblau",
    FRQ_legFarbe_weiss:        "weiß",
    FRQ_legFarbe_hellrot:      "hellrot",
    FRQ_legFarbe_gruenrot:     "grün/rot",
    FRQ_legFarbe_gruengelbrot: "grün/gelb/rot",
    // Intro je Graph
    FRQ_legIntro_ergebnis: "Graph zeigt Unterschied Ist/Soll sowohl auf der X- als auch auf der Y-Achse.",
    FRQ_legIntro_glaett:   "Graph zeigt Unterschied Gemessen/Geglättet sowohl auf der X- als auch auf der Y-Achse.",
    FRQ_legIntro_band:     "Graph zeigt berechnete Bandgrenzen und damit erreichte Mittenfrequenzen.",
    // Farb-Erklaerbloecke (§8.4)
    FRQ_legStufe_ampel_gruen: "innerhalb der Meßunsicherheit",
    FRQ_legStufe_ampel_gelb:  "gering außerhalb der Meßunsicherheit",
    FRQ_legStufe_ampel_rot:   "deutlich außerhalb der Meßunsicherheit",
    FRQ_legStufe_problem_gruen: "Messung sieht korrekt aus",
    FRQ_legStufe_problem_rot:   "Messung problematisch, siehe Tabelle",
    FRQ_legStufe_ampel_ungemessen:   "nicht gemessen",
    FRQ_legStufe_problem_ungemessen: "nicht gemessen",
    // Bedeutungen je Graph+Element (Spalte 3)
    FRQ_leg_ergebnis_strichGrau:    "Nominalfrequenz (derzeit im CI eingestellt)",
    FRQ_leg_ergebnis_strichSchwarz: "Gemessene Frequenz",
    FRQ_leg_ergebnis_pfeil:         "Verschiebung von Nominal zu Gemessen",
    FRQ_leg_ergebnis_punkt:         "Größe der Verschiebung",
    FRQ_leg_ergebnis_band:          "Meßunsicherheit",
    FRQ_leg_ergebnis_querbalkBlau:  "Restspanne (zuletzt erreichte Auflösung)",
    FRQ_leg_ergebnis_querbalken:    "Residuum (Streuung über den Verlauf, asymmetrisch)",
    FRQ_leg_ergebnis_kurve_blau:    "Meßergebnisse",
    FRQ_leg_glaett_strichGrau:    "Gemessene Frequenz",
    FRQ_leg_glaett_strichSchwarz: "Durch Glättung verschobene Frequenz",
    FRQ_leg_glaett_pfeil:         "Verschiebung von Gemessen zu Geglättet",
    FRQ_leg_glaett_punkt:         "Abweichung von der Messung",
    FRQ_leg_glaett_querbalkBlau:  "Restspanne (zuletzt erreichte Auflösung)",
    FRQ_leg_glaett_querbalken:    "Residuum (Streuung über den Verlauf, asymmetrisch)",
    FRQ_leg_glaett_kurve_blau:    "Meßergebnisse",
    FRQ_leg_glaett_kurve_gruen:   "Glättungskurve",
    FRQ_leg_band_strichGrau:    "Gewählter Ausgangspunkt",
    FRQ_leg_band_strichSchwarz: "Durch Bandberechnung erreichte Mittenfrequenz",
    FRQ_leg_band_pfeil:         "Verschiebung zur Bandmitte",
    FRQ_leg_band_punkt:         "Abweichung von der Bandmitte",
    FRQ_leg_band_querbalkBlau:  "Restspanne (zuletzt erreichte Auflösung)",
    FRQ_leg_band_querbalken:    "Residuum (Streuung über den Verlauf, asymmetrisch)",
    FRQ_leg_band_kurve_blau:    "Meßergebnisse",
    FRQ_leg_band_kurve_gruen:   "Glättungskurve",
    FRQ_leg_band_kurve_grau:    "Nominalfrequenz",
    FRQ_leg_band_flaeche_hellblau: "Frequenzband",
    FRQ_leg_band_flaeche_weiss:    "Lücke, nicht vom Frequenzband abgedeckt",
    FRQ_leg_band_flaeche_hellrot:  "Bandüberlappung",
    // Balken-Legende ELL + Stereo (BA496)
    ...
    FRQ_leg_ellbar_balken:        "Gemessene Lautstärke (negativ = zu leise, positiv = zu laut)",
    FRQ_legStufe_ellampel_gruen: "Meßunsicherheit < 1 dB, sehr gute Messung",
    FRQ_legStufe_ellampel_gelb:  "Meßunsicherheit < 3 dB, gute Messung",
    FRQ_legStufe_ellampel_rot:   "Messung sehr unsicher",
    ...
    FRQ_titel_band:     "Frequenzbandberechnung für CI-Einstellung",
    FRQ_resultsQualityPiano:           "Klaviertest: Durchlauf {round} abgeschlossen.",
    FRQ_distributionTitle: "Korrektur-Seite",
    FRQ_distributionIntro: "Legen Sie fest, wie die gemessene Frequenzabweichung als Korrektur auf Ihre beiden CI verteilt werden soll. Wenn ein CI bleiben soll, wie es ist, und nur das andere soll verändert werden, wählen Sie das anzupassende CI aus. Wenn beide gleichmäßig sich annähern sollen, wählen Sie „symmetrisch“ aus.",
    FRQ_noCiHint: "Sie haben die Seite {side} gewählt. Dort tragen Sie kein CI. Frequenzeinstellungen können nur auf CI-Seite eingestellt werden.",
    ...
    FRQ_glaettIntro: "<p style=\"margin:0 0 8px\">Die exakten Meßwerte bestmöglich umzusetzen kann zu unregelmäßiger Frequenzbandverteilung führen. Die Meßwertkurve zu glätten kann zu gleichmäßigerer Bandverteilung führen.</p><p style=\"margin:0 0 6px\">Es gibt zwei mögliche Ziele für die Glättung:</p><ol style=\"margin:0 0 8px;padding-left:1.4em\"><li>Annäherung an die Struktur der Elektrodenabstände: Dafür besonders geeignet ist das Verfahren „Ortsaffin“ oder alternativ „Polynom“ mit seinen Voreinstellungen. Im Ergebnis sieht die Kurve fast linear aus.</li><li>Annäherung mit einer beweglichen Polynom-Kurve. Die bleibt näher an den Meßwerten und glättet nur die Ausreißer.</li></ol><ul style=\"margin:0 0 8px;padding-left:1.4em\"><li>Die farbigen Punkte grün/gelb/rot geben einen Hinweis, wie gut die Kurve Ihre Messung trifft.</li><li>Die T-förmigen Residuenbalken geben die Meßungenauigkeit an; je besser die Kurve durch die Residuen läuft, desto besser paßt sie zu Ihren Meßergebnissen.</li><li>Als problematisch markierte Elektroden (z. B. verrauscht) dürfen sich in der Kurve stark verändern.</li></ul>",
    FRQ_glaettVerfahrenLegend: "Verfahren",
    FRQ_glaettVerfahrenAus: "aus",
    ...
    FRQ_glaettFitXLegend: "Kurve über",
    FRQ_glaettFitXPos: "Elektrodenposition",
    FRQ_glaettFitXIdx: "Elektrodennummer",
    FRQ_glaettGrundlageLegend: "Glättungs-Grundlage",
    FRQ_glaettGrundlageResiduum: "Residuum-Bereich",
    FRQ_glaettGrundlageRestspanne: "Restspanne",
    FRQ_glaettFormelLegend: "Gewichts-Formel",
    FRQ_glaettFormelLinear: "1/r",
    FRQ_glaettFormelQuadrat: "1/r²",
    FRQ_glaettFormelQuartisch: "1/r⁴",
    FRQ_glaettFormelGleich: "alle gleich",
    FRQ_glaettBodenLegend: "Gewichts-Boden",
    FRQ_glaettAnkerLegend: "Steife-Kopplung",
    FRQ_glaettAnkerGekoppelt: "an Gewicht gekoppelt",
    FRQ_glaettAnkerEntkoppelt: "entkoppelt",
    FRQ_glaettLageLegend: "Elektrodenlage in Cochlea",
    FRQ_glaettLageAussen: "Außenwand (Greenwood)",
    FRQ_glaettLageMitte: "Mitte",
    FRQ_glaettLageInnen: "Innenwand (Spiralganglion)",
    FRQ_glaettGradLegend: "Glättungskurve",
    FRQ_glaettGradAus: "aus",
    FRQ_glaettAchseLegend: "Rechenraum",
    FRQ_glaettAchseLog: "log-Frequenz",
    FRQ_glaettAchseOrt: "Ortsraum",
    ...
    FRQ_glaettRandfrei0: "0 Elektroden",
    FRQ_glaettRandfrei1: "1 Elektrode",
    FRQ_glaettRandfrei2: "2 Elektroden",
    FRQ_glaettRandfrei3: "3 Elektroden",
    FRQ_glaettRandfrei4: "4 Elektroden",
    FRQ_glaettRandfreiBasalLegend: "Randausschluß (basal)",
    FRQ_glaettRandfreiBasal0: "0 Elektroden",
    FRQ_glaettRandfreiBasal1: "1 Elektrode",
    FRQ_glaettRandfreiBasal2: "2 Elektroden",
    FRQ_glaettRandfreiBasal3: "3 Elektroden",
    FRQ_glaettRandfreiBasal4: "4 Elektroden",
    ...
    FRQ_bandLageInnen:  "innen (Stakhovskaya, SG)",
    FRQ_bandVerfAbf: "sABF",
    FRQ_bandRandLegend: "Randausgleich",
    FRQ_bandRandMit: "Mit Ausgleich (patenttreu)",
    FRQ_bandRandOhne: "Ohne Ausgleich",
    FRQ_bandAbfSchApLegend: "Zonen-Schwelle apikal",
    FRQ_bandAbfSchBaLegend: "Zonen-Schwelle basal",
    FRQ_bandAbfSchAussen: "nur äußerste",
    FRQ_bandAbfSchStd: "(Standard)",
    ...
    FRQ_bandCbfGewBreite: "Bandbreite gleichmäßig",
    FRQ_bandCbfApikalFreiLegend: "Freie Bänder (apikal)",
    FRQ_bandCbfBasalFreiLegend: "Freie Bänder (basal)",
    FRQ_bandCbfFrei0: "0 Elektroden",
    FRQ_bandCbfFrei1: "1 Elektrode",
    FRQ_bandCbfFrei2: "2 Elektroden",
    FRQ_bandCbfFrei3: "3 Elektroden",
    FRQ_bandCbfFrei4: "4 Elektroden",
    FRQ_bandCbfSpracheLegend: "Sprachbereich",
    ...
    FRQ_bandCbfMitteZugStark: "Stark",
    FRQ_bandEmpfAbfTooSmall: "ABF ist für die aktuelle Messlage nicht anwendbar: Der tonotope Mittelbereich enthält weniger als zwei Elektroden. Bitte ein anderes Berechnungsverfahren wählen.",
    FRQ_bandTopoLegend: "Band-Topologie",
    FRQ_bandTopoNahtlos: "Bänder lückenlos",
    FRQ_bandTopoUeber: "Bandüberschneidung",
    FRQ_bandTopoLuecke: "Bandlücken",
    FRQ_bandOptimierenLegend: "Grenzsetzung",
    FRQ_bandOptOptimiert: "Optimiert",
    FRQ_bandOptKlassisch: "Klassisch",
    FRQ_bandZielLegend: "Optimierungsziel",
    FRQ_bandZielMinimax: "Kleinster Ausreißer",
    FRQ_bandZielSumme: "Kleinster Gesamtfehler",
    FRQ_bandRandvLegend: "Randverhalten",
    FRQ_bandRandvAbschneiden: "Rand abschneiden",
    FRQ_bandRandvTreffen: "Wand treffen",
    FRQ_bandRandvLuecke: "Lücke erlauben",
    FRQ_bandRandvFrei: "Grenzen frei setzen",
    ...
    FRQ_bandStumm: "Stumm — Ausschluss vor Bandberechnung empfohlen",
    FRQ_bandEmpfColTarget: "Zielfrequenz",
    ...
    FRQ_bandAusgangFallGlatt: "(Kurve nicht geglättet, fällt auf „gemessen“ zurück)",
    FRQ_bandAusgangFallGem: "(Kurve ungemessen, fällt auf „nominelle Frequenz“ zurück)",
    FRQ_bandEmpfRatingNoise: "im Rauschen",
    FRQ_bandEmpfRatingSlight: "leicht daneben",
    FRQ_bandEmpfRatingClear: "deutlich daneben",
    FRQ_bandTipHeard: "gehört",
    ...
    FRQ_glaettPianoBtn: "Töne gemäß Glättung abspielen",
    ...
    FRQ_elektrodenPianoBtn:   "Elektroden über Töne anspielen",
    FRQ_elektrodenPianoTitle: "Elektroden über Töne anspielen",
    FRQ_elektrodenPianoApply: "Frequenzabgleich aktivieren",
    ...
    tabSprachtest: "Sprachtest",
    stTitle: “Sprachtest — Sprachverstehen im Störgeräusch”,
    stIntro1: “Dieser Test mißt Sprachverstehen im Störgeräusch und folgt dem Konzept des Oldenburger Sprachtests (OLSA).”,
    stIntro2: “Der Test dient nur Ihrer persönlichen Information. Die abgespielten Sätze folgen der Einstellung im Player. Sie können somit vergleichen, wie gut Sie mit oder ohne Korrekturen gemäß der übrigen Messungen Sprache verstehen.”,
    stInstruction: “Ihnen werden Sätze mit unterschiedlich lautem Hintergrundgeräusch vorgespielt. Die Sätze sind bewußt sinnlos und folgen immer der gleichen Struktur.\nWählen Sie in der Tabelle unten die Wörter aus, die Sie verstanden haben.\nBei Unsicherheit dürfen Sie raten oder das Wort auslassen.\nJeder Satz wird nur einmal abgespielt.”,
    stIntro4: “Das Ergebnis können Sie anschließend im Reiter Meßergebnisse → Sprachtest sehen. Anders als die anderen Tests kann dieser Test nicht pausiert und später fortgesetzt werden. Ein neuer Start überschreibt frühere Testergebnisse.”,
    stTrainHint: “Vor der Messung laufen einige Übungssätze, die nicht gewertet werden.”,
    stOverwriteTitle: “Früheres Ergebnis vorhanden”,
    ...
    stResCourseTitle: "Adaptionsverlauf (SNR über Satznummer)",
    stResCourseExplain: "Jeder Punkt zeigt den SNR-Wert (Lautstärkeverhältnis Sprache / Geräusch), mit dem der jeweilige Satz dargeboten wurde. Das Verfahren passt diesen Wert nach jedem Satz an: haben Sie viel verstanden, wird der nächste Satz schwerer gestellt (geringerer SNR); haben Sie wenig verstanden, leichter.\n\nDie rote gestrichelte Linie ist der berechnete SRT — der Mittelwert der letzten 20 Sätze, um den die Kurve am Ende pendelt.\n\nWas eine gute Kurve zeigt: In den ersten Sätzen läuft die Kurve rasch auf einen Bereich ein (grobe Phase), danach pendelt sie eng um einen Wert (feine Phase). Je enger das Pendeln am Ende, desto zuverlässiger ist das Ergebnis.",
    stResScatterTitle: "Streuung: SNR gegen verstandene Wörter",
    stResScatterNote: "Ergänzende Darstellung, kein klinischer OLSA-Standard.",
    stResScatterExplain: "Jeder Punkt entspricht einem Satz: die waagrechte Achse zeigt den SNR dieses Satzes, die senkrechte Achse, wie viele der fünf Wörter Sie richtig hatten.\n\nDie rote Linie markiert den SRT (50-%-Punkt). Die gestrichelte waagrechte Linie bei 2,5 Wörtern zeigt die 50-%-Schwelle. Im Idealfall liegen die meisten Punkte nahe dieser Kreuzung — Punkte weit links zeigen schwierige Sätze (schlechter SNR, wenig verstanden), Punkte weit rechts leichte (guter SNR, viel verstanden).",
    stResSlopeTitle: "Steigung der Verständniskurve",
    stResSlopeNote: "Grobe Schätzung aus einem einzelnen Durchgang — nur als Größenordnung.",
    stResSlopeExplain: "Die Steigung beschreibt, wie stark sich Ihr Wortverständnis verbessert, wenn der SNR um 1 dB günstiger wird — angegeben in Prozent Verständnis pro Dezibel. Ein Wert von 15 %/dB bedeutet: wird die Sprache 1 dB lauter relativ zum Geräusch, verstehen Sie etwa 15 % mehr Wörter.\n\nNormalhörende haben eine sehr steile Kurve (ca. 17 %/dB). CI-Träger haben häufig eine flachere Kurve — das heißt, sie brauchen einen größeren SNR-Unterschied, um den gleichen Verständnisgewinn zu erzielen.\n\nAchtung: Diese Schätzung aus einem einzelnen adaptiven Durchgang ist ungenau, weil das Verfahren die Sätze bewusst nahe der 50-%-Marke häuft und extreme SNR-Bereiche kaum abdeckt. Sie gibt nur eine grobe Größenordnung.",
    stDoneBody: "Das Ergebnis steht im Reiter „Meßergebnisse“ unter „Sprachtest“.",
