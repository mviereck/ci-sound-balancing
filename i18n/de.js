...
Object.assign(L.de, {
    ...
    latenzResTitle: "Latenz",
    latenzResLabel: "Gemessener Zeitversatz",
    latenzResNoneText: "Noch keine Latenz gemessen. Im Reiter „Messungen” → „Latenz” durchführen.",
    latenzResNoOffset: "Kein Versatz.",
    latenzResLeftFaster: "Linke Seite war {ms} ms schneller.",
    latenzResRightFaster: "Rechte Seite war {ms} ms schneller.",
    latenzResMeasuredWith: "Gemessen mit",
    latenzResInterval: "Klick-Intervall",
    latenzResApplied: "Im Player angewendet",
    latenzClearBtnLabel: "🗑 Latenz-Ergebnis löschen",
    latenzClearConfirm: "Latenz-Meßergebnis löschen?",
    latenzTypeClick: "Klick (breitband)",
    latenzTypeBurst500: "Tieftöner 500 Hz",
    latenzTypeBurst1500: "Mittelton 1500 Hz",
    latenzTypeBurst4000: "Hochton 4 kHz",
    latenzBTWarning: "<strong>⚠️ Wichtig: Diesen Test nur mit Kabel-Kopfhörern durchführen.</strong><br>Bluetooth fügt eigene, unterschiedliche Latenzen pro Ohr hinzu und verfälscht die Messung. Andere Tests funktionieren mit Bluetooth — dieser hier <em>nicht</em>.",
    latenzMeasTitle: "Latenz-Messung",
    latenzMaturityHint: "Dieser Test ist bereits brauchbar und funktioniert. Verbesserungen wird es vermutlich noch geben.",
    latenzMeasIntro2: "Messung des Zeitversatzes von links und rechts, wann Töne ankommen.",
    latenzLocHint: "Wenn die Lautstärke links und rechts sehr gut ausgeglichen ist, können Sie als Anhaltspunkt auch darauf achten, ‚wo‘ Sie den Ton hören. Eher links, rechts, oder mittig im Kopf.",
    latenzMeasIntro: "Stelle mit dem Schieber den Versatz ein, bei dem die Klicks gleichzeitig wahrgenommen werden. Pfeiltasten: 1 ms — Shift+Pfeil: 0,1 ms — Strg+Pfeil: 10 ms.",
    latenzSliderMinusLabel: "−200 ms (rechts verzögern)",
    latenzSliderZeroLabel: "0",
    latenzSliderPlusLabel: "+200 ms (links verzögern)",
    latenzIntervalLabel: "Klick-Intervall",
    latenzTypeLabel: "Klangtyp",
    latenzAudibleLabel: "Hörbar während Messung",
    latenzToggleClicks: "Klicktöne hörbar",
    latenzTogglePlayer: "Player hörbar",
    latenzLockedHint: "Test läuft. Stoppe den Test, um die Tabs zu wechseln.",
    latenzUniqueRange: "Eindeutiger Bereich:",
    latenzUniqueRangeAmbig: "(bei mehr Versatz wird die Richtung mehrdeutig)",
    yes: "ja",
    no: "nein",
    introAudioDesc:
    ...
    archivStereobalanceMean: "Mittelwert",
    archivLatenzValue: "Wert",
    archivLatenzClick: "Click-Typ",
    archivLatenzInterval: "Intervall",
    ...
    archivSchieberMode: "Schieber-Tab: Modus",
    archivSchieberVariant: "Schieber-Tab: Variante",
    archivSchieberShowMeas: "Schieber-Tab: Messung einblenden",
    archivSchieberShowCurves: "Schieber-Tab: Kurven einblenden",
    ...
    tabKurven: "Kurven",
    schieberTitle: "Schieber: Manuelle Einzeljustierung von Elektroden",
    schieberDesc: "Senkrechte Balken pro Elektrode. Eine Elektrode durch Anklicken zur Bearbeitung auswählen. Anpassung mit Pfeiltasten ↑/↓ (±0.5 dB, Shift = ±0.1 dB). ←/→ wechselt zwischen Elektroden.",
    schieberShowLabel: "Anzeigen:",
    schieberSrcSlider: "Schieber",
    schieberSrcMeas: "Messung",
    schieberSrcCurves: "Kurven",
    schieberReset: "Manuelle Werte zurücksetzen auf 0",
    schieberElLabel: "Elektrode",
    schieberVlLabel: "Wert",
    schieberKeyHint: "Tipp: Pfeiltasten links/rechts wechseln die Elektrode, hoch/runter ändern den Wert. Mit Shift kleinerer Schritt.",
    schieberWarpHint:
      "Frequenz-Warping aktiv — die eingeblendeten Kurven verschieben " +
      "sich pro Elektrode geringfügig.",
    schieberModeLabel: "Modus:",
    schieberModeRelative: "relativ (dB)",
    schieberModeAbsolute: "absolut (qu/CL/CU)",
    schieberVariantLabel: "Anzeige:",
    schieberVarSum: "nur Summe",
    ...
    stereobalanceRunningTitle: "Stereo-Balance-Test läuft",
    stereobalanceRunningHint: "Passen Sie die Lautstärke an, bis sich beide Seiten gleich laut anhören.",
    ...
    optLR: "L → R",
    optRL: "R → L",
    stereobalanceTitle: "Lautstärkenvergleich Links/Rechts",
    stereobalanceMaturityHint: "Dieser Test funktioniert grundsätzlich, wird aber sicher noch überarbeitet werden.",
    stereobalanceDesc: "Dieser Test vergleicht die wahrgenommene Lautstärke links und rechts für jedes Elektrodenpaar. Damit soll erreicht werden, daß Sie links und rechts gleich laut hören.",
    stereobalanceOrderLbl: "Reihenfolge:",
    stereobalanceSideLbl: "Seitenfolge:",
    ...
    stereobalanceNoResultsMsg: "Noch keine Ergebnisse. Führen Sie erst eine Messung in „Messungen → Stereo-Balance” durch.",
    stereobalanceResTitle: "Ergebnisse L/R-Vergleich",
    stereobalanceMedianLabel: "Empfohlener Balance-Offset (Mittelwert)",
    stereobalanceResDesc: "Positiv = Rechts lauter als Links (rechts abschwächen oder links anheben). Negativ = Links lauter.",
    stereobalanceClearBtnLabel: "🗑 Ergebnisse löschen",
    stereobalanceResNote: "Der empfohlene Globalwert (Mittelwert) wird automatisch als Stereo-Balance-Offset oben eingetragen.",
    stereobalanceBalEqual: "Seiten nahezu gleich laut",
    stereobalanceRightLouder: "Links anheben oder Rechts absenken",
    stereobalanceLeftLouder: "Rechts anheben oder Links absenken",
    stereobalanceThHz1: "Hz Links",
    stereobalanceThHz2: "Hz Rechts",
    stereobalanceThMeaning: "Bedeutung",
    stereobalanceMeaningRight: "Rechts lauter",
    stereobalanceMeaningLeft: "Links lauter",
    stereobalanceMeaningEqual: "Gleich",
    ...
    latenzInstruction: "Schiebe den Schieber, bis die Klicks links und rechts gleichzeitig erscheinen.",
    sliderHintMs:   "1 ms",
    latenzVerfahrenLabel: "Latenz",
    latenzVortestBalanceMissing:  "Hinweis: Vortest „Stereo-Balance“ wurde noch nicht durchgeführt. Die Messung läuft trotzdem, ist aber genauer, wenn die Balance vorab gleichgezogen ist.",
});
