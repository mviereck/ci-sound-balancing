...
Object.assign(L.de, {
    ...
    FRQ_glaettIntro: "<p style=\"margin:0 0 8px\">Die exakten Meßwerte bestmöglich umzusetzen kann zu unregelmäßiger Frequenzbandverteilung führen. Die hier angebotenen Kurven versuchen, aus den Meßdaten einen plausiblen gleichmäßigen Verlauf zu machen.</p><ul style=\"margin:0 0 8px;padding-left:1.4em\"><li>Prüfen Sie, ob eine der Kurven Ihrer Messung nahekommt. Die farbigen Punkte grün/gelb/rot geben einen Hinweis, wie gut getroffen wurde.</li><li>Die T-förmigen Residuenbalken geben die Meßungenauigkeit an; je besser die Kurve durch die Residuen läuft, desto besser paßt sie zu Ihren Meßergebnissen.</li><li>Als problematisch markierte Elektroden, z. B. verrauscht, dürfen stark abweichen.</li></ul><p style=\"margin:0\">Besonders empfohlen werden die beiden Ortsaffin-Verfahren. Sie schätzen aus den Meßwerten die tatsächliche Lage des Implantates in der Cochlea und passen die Frequenzverschiebung entsprechend an.</p>",
