...
Object.assign(L.es, {
    ...
    FRQ_resultsColBand: "Recomendación de banda",
    FRQ_bandOverlapCellTip: "Medición cruzada - no se puede calcular el límite de banda",
    FRQ_bandOverlapNote: "No se pueden calcular bandas de frecuencia para la medición actual: los electrodos {els} presentan frecuencias percibidas que se cruzan, por lo que no resulta una secuencia de bandas inequívoca.",
    FRQ_bandExplain: "Recomendación de banda. Las bandas de frecuencia propuestas se calculan a partir de las frecuencias centrales percibidas: el límite entre dos electrodos vecinos se sitúa en la media logarítmica de sus frecuencias. Es una aproximación neutral respecto al fabricante - según el implante y la estrategia de codificación, son posibles otras distribuciones de bandas (p. ej. logarítmica, lineal-logarítmica o basada en la anatomía).",
    FRQ_randHinweisIntro: "El límite inferior del rango de frecuencias global suele estar fijado por los fabricantes bastante más bajo de lo que da el cálculo logarítmico, por lo que el espectro auditivo es mayor. Hacia arriba, en cambio, el espectro está algo estrechado. Desviación conocida respecto al cálculo logarítmico:",
    FRQ_randCol1: "abajo",
    FRQ_randCol2: "arriba",
    FRQ_randHinweisOutro: "El margen adicional hacia abajo debería aprovecharse al reajustar las frecuencias. Hacia arriba puede adoptarse el valor calculado de la tabla.",
    FRQ_randBlock2Intro: "Aplicado a los anchos de banda indicados arriba, esto significaría:",
    ...
    FRQ_resultsTipBand: "Ancho de banda",
