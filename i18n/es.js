...
Object.assign(L.es, {
    ...
    implValidateIIDRRangeHard: "IIDR ({val} dB) está fuera del rango plausible ({min}–{max} dB)",
    implValidateIIDRRangeTypical: "IIDR ({val} dB) está fuera del rango habitual ({min}–{max} dB) — el estándar es 40 dB",
    sweep: "▶ Sweep",
    stop: "■ Detener",
    ...
    recommend:
      "Recomendación: <br> - Ajuste el tono tan alto que resulte casi incómodo.<br> - En lo posible, utilice una conexión Bluetooth para el streaming.<br> - Realice primero el procedimiento «Completo» y después «Convergencia». Ambos pueden repetirse cuantas veces se desee.<br> - «Completo» se organiza por rondas. En cada ronda, cada electrodo se compara exactamente una vez. Las primeras estimaciones útiles aparecen a partir de unas tres o cuatro rondas completadas; los valores fiables, solo tras una pasada completa de todas las rondas.<br> - Si se interrumpe, al volver a iniciar «Completo» se continuará donde se dejó.<br> - Una marca bajo el deslizador muestra el valor calculado a partir de todas las mediciones realizadas hasta ahora; la zona coloreada indica la incertidumbre de esa estimación.<br> - En la pestaña Resultados de medición se puede valorar la calidad del ajuste por los colores.",
    ...
    printHeaderToolVersion: "Valores obtenidos con CI Sound Balancing Tool {VERSION} (www.ci-sound-balancing.org)",
    ...
    freqExclHint:
      "Puede excluir de las pruebas los electrodos poco audibles en la columna <b>Excluir</b>. Los electrodos desactivados se excluyen automáticamente de las pruebas.",
    ...
    fmModeSlider:      "Pre-estimación (deslizador)",
    ...
    fmrClearSliderBtnLabel: "🗑 Borrar solo pre-estimación (deslizador)",
    ...
    fmrClearSliderConfirm: "¿Borrar solo las pre-estimaciones del deslizador? Los resultados adaptativos se conservan.",
    ...
    fmExplainSlider:   "El procedimiento de pre-estimación permite ajustar la frecuencia por electrodo con un deslizador hasta que los tonos suenen igual de agudos en ambos lados. Estos valores se usan como punto de partida para el procedimiento adaptativo más preciso, acortando el tiempo de prueba. Tras iniciar el procedimiento adaptativo, ya no es posible el ajuste por deslizador.",
    fmSliderInstruction: "Ajuste el deslizador hasta que ambos tonos suenen igual de agudos.",
    fmExplainSliderScience: "La pre-estimación le pide que desplace manualmente la frecuencia de un lado para que los tonos suenen igual de agudos en ambos lados. Es un método subjetivo y rápido — su precisión depende de cuán seguro esté al desplazar el deslizador. <br><br>Estos valores no sustituyen un procedimiento adaptativo, sino que sirven de <strong>punto de partida</strong>: el procedimiento adaptativo obtiene tiempos de prueba claramente más cortos con una buena pre-estimación, porque no tiene que partir desde 0 cent.<br><br>El método del deslizador no es un procedimiento de medición científico y está particularmente expuesto a errores psicoacústicos de percepción.",
    cumulativeDb: "Total",
    ...
    supportIntro2: "Para que siga así y la herramienta pueda seguir creciendo, necesita apoyo regular. Ya 1 o 2 euros al mes ayudan de forma notable. Si 50 usuarios participan, se cubre la necesidad mensual total. También son bienvenidas las donaciones puntuales.",
    ...
    supportTableHeadFull: "Versión completa",
    ...
    supportFutureTitle: "Lo que se hace posible con financiación completa:",
    supportFutureIntro: "<em>Planeado, actualmente frenado por falta de medios:</em>",
    supportFuturePlan1: "procedimientos de prueba mejorados",
    supportFuturePlan2: "mejor simulación de adaptación de frecuencia modificada",
    supportFuturePlan3: "soporte de otros idiomas",
    supportFuturePlan4: "biblioteca de audio más amplia (más frases, audiolibros, música)",
    supportFutureConsider: "<em>En estudio:</em>",
    supportFutureConsider1: "Área de entrenamiento auditivo",
    supportFutureConsider2: "Análisis de tinnitus con tonos de enmascaramiento y notch",
