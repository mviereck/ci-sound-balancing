...
Object.assign(L.es, {
    ...
    FRQ_glaettIntro: "<p style=\"margin:0 0 8px\">Reproducir los valores medidos exactos con la mayor fidelidad posible puede provocar una distribución irregular de las bandas de frecuencia. Las curvas que se ofrecen aquí intentan obtener a partir de los datos de medición una progresión uniforme y plausible.</p><ul style=\"margin:0 0 8px;padding-left:1.4em\"><li>Compruebe si alguna de las curvas se aproxima a su medición. Los puntos de color verde/ámbar/rojo indican el grado de ajuste.</li><li>Las barras de residuos en forma de T indican la incertidumbre de medición; cuanto mejor pase la curva por los residuos, mejor coincidirá con sus resultados.</li><li>Los electrodos marcados como problemáticos, p. ej. ruidosos, pueden desviarse notablemente.</li></ul><p style=\"margin:0\">Se recomiendan especialmente los dos métodos de posición afín. Estiman, a partir de los valores medidos, la posición real del implante en la cóclea y ajustan el desplazamiento de frecuencia en consecuencia.</p>",
