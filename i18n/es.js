...
Object.assign(L.es, {
    ...
    latenzResTitle: "Latencia",
    latenzResLabel: "Desfase temporal medido",
    latenzResNoneText: "Aún no se ha medido la latencia. Realícela en la pestaña «Mediciones» → «Latencia».",
    latenzResNoOffset: "Sin desfase.",
    latenzResLeftFaster: "El lado izquierdo fue {ms} ms más rápido.",
    latenzResRightFaster: "El lado derecho fue {ms} ms más rápido.",
    latenzResMeasuredWith: "Medido con",
    latenzResInterval: "Intervalo de clic",
    latenzResApplied: "Aplicado en el reproductor",
    latenzClearBtnLabel: "🗑 Borrar resultado de latencia",
    latenzClearConfirm: "¿Borrar el resultado de la medición de latencia?",
    latenzTypeClick: "Clic (banda ancha)",
    latenzTypeBurst500: "Grave 500 Hz",
    latenzTypeBurst1500: "Medio 1500 Hz",
    latenzTypeBurst4000: "Agudo 4 kHz",
    latenzBTWarning: "<strong>⚠️ Importante: realice esta prueba únicamente con auriculares por cable.</strong><br>El Bluetooth añade latencias propias y distintas en cada oído y falsea la medición. Otras pruebas funcionan con Bluetooth — esta <em>no</em>.",
    latenzMeasTitle: "Medición de latencia",
    latenzMaturityHint: "Esta prueba ya es utilizable y funciona. Probablemente todavía haya mejoras.",
    latenzMeasIntro2: "Medición del desfase temporal entre la llegada del tono al lado izquierdo y al derecho.",
    latenzLocHint: "Si la sonoridad izquierda y derecha está muy bien equilibrada, también puede orientarse por «dónde» escucha el tono: más a la izquierda, a la derecha o centrado en la cabeza.",
    latenzMeasIntro: "Ajuste con el deslizador el desfase con el que los clics se perciben simultáneos. Flechas: 1 ms — Shift+flecha: 0,1 ms — Ctrl+flecha: 10 ms.",
    latenzSliderMinusLabel: "−200 ms (retrasar derecha)",
    latenzSliderZeroLabel: "0",
    latenzSliderPlusLabel: "+200 ms (retrasar izquierda)",
    latenzIntervalLabel: "Intervalo de clic",
    latenzTypeLabel: "Tipo de sonido",
    latenzAudibleLabel: "Audible durante la medición",
    latenzToggleClicks: "Clics audibles",
    latenzTogglePlayer: "Reproductor audible",
    latenzLockedHint: "Prueba en curso. Deténgala para cambiar de pestaña.",
    latenzUniqueRange: "Rango inequívoco:",
    latenzUniqueRangeAmbig: "(con más desfase la dirección se vuelve ambigua)",
    yes: "sí",
    no: "no",
    introAudioDesc:
    ...
    archivStereobalanceMean: "Media",
    archivLatenzValue: "Valor",
    archivLatenzClick: "Tipo de clic",
    archivLatenzInterval: "Intervalo",
    ...
    archivSchieberMode: "Pestaña Deslizadores: modo",
    archivSchieberVariant: "Pestaña Deslizadores: variante",
    archivSchieberShowMeas: "Pestaña Deslizadores: mostrar medición",
    archivSchieberShowCurves: "Pestaña Deslizadores: mostrar curvas",
    ...
    tabKurven: "Curvas",
    schieberTitle: "Deslizadores: ajuste manual individual de electrodos",
    schieberDesc: "Barras verticales por electrodo. Seleccione un electrodo haciendo clic para editarlo. Ajuste con las flechas ↑/↓ (±0,5 dB, Shift = ±0,1 dB). ←/→ cambia entre electrodos.",
    schieberShowLabel: "Mostrar:",
    schieberSrcSlider: "Deslizadores",
    schieberSrcMeas: "Medición",
    schieberSrcCurves: "Curvas",
    schieberReset: "Restablecer valores manuales a 0",
    schieberElLabel: "Electrodo",
    schieberVlLabel: "Valor",
    schieberKeyHint: "Consejo: las flechas izquierda/derecha cambian de electrodo, arriba/abajo cambian el valor. Con Shift, paso menor.",
    schieberWarpHint:
      "Warping de frecuencia activo — las curvas mostradas se desplazan " +
      "ligeramente por electrodo.",
    schieberModeLabel: "Modo:",
    schieberModeRelative: "relativo (dB)",
    schieberModeAbsolute: "absoluto (qu/CL/CU)",
    schieberVariantLabel: "Visualización:",
    schieberVarSum: "solo suma",
    ...
    fmrClearSliderBtnLabel: "🗑 Borrar solo valores de reajuste",
    ...
    fmrClearSliderConfirm: "¿Borrar valores de reajuste?",
    ...
    stereobalanceRunningHint: "Ajuste el volumen hasta que ambos lados suenen igual de fuertes.",
    ...
    optLR: "L → R",
    optRL: "R → L",
    stereobalanceTitle: "Comparación de volumen Izquierda/Derecha",
    stereobalanceMaturityHint: "Esta prueba funciona en principio, pero con seguridad aún será reelaborada.",
    stereobalanceDesc: "Esta prueba compara la sonoridad percibida izquierda y derecha para cada par de electrodos. Con ella se pretende lograr que oiga igual de fuerte por izquierda y derecha.",
    stereobalanceOrderLbl: "Orden:",
    stereobalanceSideLbl: "Orden de lados:",
    ...
    stereobalanceNoResultsMsg: "Aún no hay resultados. Realice primero una medición en «Mediciones → Balance estéreo».",
    stereobalanceResTitle: "Resultados comparación L/R",
    stereobalanceMedianLabel: "Offset de balance recomendado (media)",
    stereobalanceResDesc: "Positivo = derecha más fuerte que izquierda (atenuar derecha o subir izquierda). Negativo = izquierda más fuerte.",
    stereobalanceClearBtnLabel: "🗑 Borrar resultados",
    stereobalanceResNote: "El valor global recomendado (media) se introduce automáticamente arriba como offset de balance estéreo.",
    stereobalanceBalEqual: "Lados prácticamente igual de fuertes",
    stereobalanceRightLouder: "Subir izquierda o bajar derecha",
    stereobalanceLeftLouder: "Subir derecha o bajar izquierda",
    stereobalanceThHz1: "Hz Izquierda",
    stereobalanceThHz2: "Hz Derecha",
    stereobalanceThMeaning: "Significado",
    stereobalanceMeaningRight: "Derecha más fuerte",
    stereobalanceMeaningLeft: "Izquierda más fuerte",
    stereobalanceMeaningEqual: "Igual",
    ...
    latenzInstruction: "Mueve el deslizador hasta que los clics de la izquierda y la derecha aparezcan al mismo tiempo.",
    sliderHintMs:   "1 ms",
    latenzVerfahrenLabel: "Latencia",
    latenzVortestBalanceMissing:  "Aviso: la prueba previa «Balance estéreo» aún no se ha realizado. La medición funciona igualmente, pero es más precisa si el balance se ha igualado antes.",
});
