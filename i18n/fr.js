...
Object.assign(L.fr, {
    ...
    recommend:
      "Recommandation : <br> - Réglez le son si fort que ce soit presque désagréable.<br> - Utilisez si possible une connexion Bluetooth pour le streaming.<br> - Effectuez d'abord la procédure « Complet », puis « Convergence ». Les deux peuvent être répétées autant de fois que souhaité.<br> - « Complet » se divise en tours. Dans chaque tour, chaque électrode est comparée exactement une fois. Les premières estimations utilisables apparaissent à partir d'environ trois ou quatre tours terminés ; des valeurs fiables seulement après un parcours complet de tous les tours.<br> - En cas d'interruption, au prochain démarrage de « Complet » la séance reprend là où elle s'est arrêtée.<br> - Une marque sous le curseur indique la valeur calculée à partir de toutes les mesures précédentes ; la zone colorée montre l'incertitude de cette estimation.<br> - Dans l'onglet Résultats de mesure, la qualité de l'ajustement peut être évaluée à l'aide des couleurs.",
    ...
    archivMeasSweepNote: "Sweep complet commencé : tour {round}, paires confirmées {done} sur {total}.",
    archivCfgIdr: "IDR",
    archivCfgIidr: "IIDR",
