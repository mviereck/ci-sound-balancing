...
Object.assign(L.fr, {
    ...
    latenzResTitle: "Latence",
    latenzResLabel: "Décalage temporel mesuré",
    latenzResNoneText: "Aucune latence mesurée pour l'instant. Effectuer dans l'onglet « Mesures » → « Latence ».",
    latenzResNoOffset: "Pas de décalage.",
    latenzResLeftFaster: "Le côté gauche était {ms} ms plus rapide.",
    latenzResRightFaster: "Le côté droit était {ms} ms plus rapide.",
    latenzResMeasuredWith: "Mesuré avec",
    latenzResInterval: "Intervalle de clics",
    latenzResApplied: "Appliqué dans le Player",
    latenzClearBtnLabel: "🗑 Effacer le résultat de latence",
    latenzClearConfirm: "Effacer le résultat de mesure de latence ?",
    latenzTypeClick: "Clic (large bande)",
    latenzTypeBurst500: "Basse 500 Hz",
    latenzTypeBurst1500: "Médium 1500 Hz",
    latenzTypeBurst4000: "Aigu 4 kHz",
    latenzBTWarning: "<strong>⚠️ Important : effectuer ce test uniquement avec des écouteurs filaires.</strong><br>Le Bluetooth ajoute ses propres latences, différentes pour chaque oreille, et fausse la mesure. Les autres tests fonctionnent avec le Bluetooth — celui-ci <em>non</em>.",
    latenzMeasTitle: "Mesure de latence",
    latenzMaturityHint: "Ce test est déjà utilisable et fonctionne. Des améliorations sont vraisemblablement encore à venir.",
    latenzMeasIntro2: "Mesure du décalage temporel entre la gauche et la droite, à quel moment les sons arrivent.",
    latenzLocHint: "Si l'intensité gauche et droite est très bien équilibrée, vous pouvez aussi, comme point de repère, faire attention à « où » vous entendez le son. Plutôt à gauche, à droite, ou au milieu de la tête.",
    latenzMeasIntro: "Réglez avec le curseur le décalage pour lequel les clics sont perçus simultanément. Touches fléchées : 1 ms — Maj+Flèche : 0,1 ms — Ctrl+Flèche : 10 ms.",
    latenzSliderMinusLabel: "−200 ms (retarder la droite)",
    latenzSliderZeroLabel: "0",
    latenzSliderPlusLabel: "+200 ms (retarder la gauche)",
    latenzIntervalLabel: "Intervalle de clics",
    latenzTypeLabel: "Type de son",
    latenzAudibleLabel: "Audible pendant la mesure",
    latenzToggleClicks: "Clics audibles",
    latenzTogglePlayer: "Lecteur audible",
    latenzLockedHint: "Test en cours. Arrêtez le test pour changer d'onglet.",
    latenzUniqueRange: "Plage univoque :",
    latenzUniqueRangeAmbig: "(avec un décalage plus grand, la direction devient ambiguë)",
    yes: "oui",
    no: "non",
    introAudioDesc:
    ...
    archivStereobalanceMean: "Moyenne",
    archivLatenzValue: "Valeur",
    archivLatenzClick: "Type de clic",
    archivLatenzInterval: "Intervalle",
    ...
    archivSchieberMode: "Onglet Curseurs : mode",
    archivSchieberVariant: "Onglet Curseurs : variante",
    archivSchieberShowMeas: "Onglet Curseurs : afficher mesure",
    archivSchieberShowCurves: "Onglet Curseurs : afficher courbes",
    ...
    tabKurven: "Courbes",
    schieberTitle: "Curseurs : ajustement manuel individuel d'électrodes",
    schieberDesc: "Barres verticales par électrode. Sélectionner une électrode en cliquant pour l'éditer. Ajustement avec les touches fléchées ↑/↓ (±0.5 dB, Maj = ±0.1 dB). ←/→ change d'électrode.",
    schieberShowLabel: "Afficher :",
    schieberSrcSlider: "Curseurs",
    schieberSrcMeas: "Mesure",
    schieberSrcCurves: "Courbes",
    schieberReset: "Réinitialiser les valeurs manuelles à 0",
    schieberElLabel: "Électrode",
    schieberVlLabel: "Valeur",
    schieberKeyHint: "Astuce : les touches fléchées gauche/droite changent d'électrode, haut/bas modifient la valeur. Avec Maj, pas plus petit.",
    schieberWarpHint:
      "Warping fréquentiel actif — les courbes affichées se décalent " +
      "légèrement par électrode.",
    schieberModeLabel: "Mode :",
    schieberModeRelative: "relatif (dB)",
    schieberModeAbsolute: "absolu (qu/CL/CU)",
    schieberVariantLabel: "Affichage :",
    schieberVarSum: "somme seulement",
    ...
    stereobalanceRunningHint: "Ajustez le volume jusqu'à ce que les deux côtés paraissent aussi forts.",
    ...
    optLR: "G → D",
    optRL: "D → G",
    stereobalanceTitle: "Comparaison d'intensité Gauche/Droite",
    stereobalanceMaturityHint: "Ce test fonctionne en principe, mais sera certainement encore retravaillé.",
    stereobalanceDesc: "Ce test compare l'intensité perçue gauche et droite pour chaque paire d'électrodes. Le but est que vous entendiez aussi fort à gauche et à droite.",
    stereobalanceOrderLbl: "Ordre :",
    stereobalanceSideLbl: "Ordre des côtés :",
    ...
    stereobalanceNoResultsMsg: "Pas encore de résultats. Effectuez d'abord une mesure dans « Mesures → Balance stéréo ».",
    stereobalanceResTitle: "Résultats comparaison G/D",
    stereobalanceMedianLabel: "Offset de balance recommandé (moyenne)",
    stereobalanceResDesc: "Positif = droite plus forte que gauche (réduire la droite ou augmenter la gauche). Négatif = gauche plus forte.",
    stereobalanceClearBtnLabel: "🗑 Effacer les résultats",
    stereobalanceResNote: "La valeur globale recommandée (moyenne) est automatiquement inscrite comme offset de balance stéréo en haut.",
    stereobalanceBalEqual: "Côtés presque aussi forts",
    stereobalanceRightLouder: "Augmenter la gauche ou abaisser la droite",
    stereobalanceLeftLouder: "Augmenter la droite ou abaisser la gauche",
    stereobalanceThHz1: "Hz Gauche",
    stereobalanceThHz2: "Hz Droite",
    stereobalanceThMeaning: "Signification",
    stereobalanceMeaningRight: "Droite plus forte",
    stereobalanceMeaningLeft: "Gauche plus forte",
    stereobalanceMeaningEqual: "Égal",
    ...
    latenzInstruction: "Déplacez le curseur jusqu'à ce que les clics à gauche et à droite apparaissent en même temps.",
    sliderHintMs:   "1 ms",
    latenzVerfahrenLabel: "Latence",
    latenzVortestBalanceMissing:  "Remarque : le pré-test « Balance stéréo » n'a pas encore été effectué. La mesure fonctionne quand même, mais elle est plus précise si la balance a été ajustée auparavant.",
});
