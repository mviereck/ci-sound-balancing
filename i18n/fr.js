...
Object.assign(L.fr, {
    ...
    FRQ_resultsColBand: "Recommandation de bande",
    FRQ_bandOverlapCellTip: "Mesure croisée - aucune limite de bande calculable",
    FRQ_bandOverlapNote: "Aucune bande de fréquence ne peut être calculée pour la mesure actuelle : les électrodes {els} présentent des fréquences perçues qui se croisent, de sorte qu'aucune séquence de bandes non ambiguë n'en résulte.",
    FRQ_bandExplain: "Recommandation de bande. Les bandes de fréquence proposées sont calculées à partir des fréquences centrales perçues : la limite entre deux électrodes voisines se situe à la moyenne logarithmique de leurs fréquences. Il s'agit d'une approximation neutre vis-à-vis du fabricant - selon l'implant et la stratégie de codage, d'autres répartitions de bandes sont possibles (p. ex. logarithmique, linéaire-logarithmique ou basée sur l'anatomie).",
    FRQ_randHinweisIntro: "La limite inférieure de la plage de fréquences globale est en règle générale fixée par les fabricants nettement plus bas que ne le donne le calcul logarithmique ; le spectre auditif est donc plus large. Vers le haut, en revanche, le spectre est légèrement resserré. Écart connu par rapport au calcul logarithmique :",
    FRQ_randCol1: "bas",
    FRQ_randCol2: "haut",
    FRQ_randHinweisOutro: "La plage supplémentaire vers le bas devrait être exploitée lors d'un nouveau réglage des fréquences. Vers le haut, la valeur calculée du tableau peut être reprise.",
    FRQ_randBlock2Intro: "Appliqué aux largeurs de bande indiquées ci-dessus, cela donnerait :",
    ...
    FRQ_resultsTipBand: "Bande passante",
