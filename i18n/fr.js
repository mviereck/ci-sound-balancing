...
Object.assign(L.fr, {
    ...
    tabSprachtest: "Test de parole",
    stTitle: "Test de parole — compréhension dans le bruit",
    stInstruction: "Vous entendrez des phrases avec un bruit de fond constant. Le volume des phrases varie — ne vous découragez pas, vous ne comprendrez souvent pas toute la phrase. Dans chaque colonne, choisissez le mot entendu ; aucune sélection signifie « non compris ».",
    stTrainHint: "Quelques phrases d'entraînement précèdent la mesure et ne sont pas comptabilisées.",
    ...
    stResCourseExplain: "",
    stResScatterTitle: "Dispersion : SNR selon les mots compris",
    stResScatterNote: "Vue complémentaire, pas un standard OLSA clinique.",
    stResScatterExplain: "",
