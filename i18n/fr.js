...
Object.assign(L.fr, {
    ...
    FRQ_glaettIntro: "<p style=\"margin:0 0 8px\">Reproduire au plus près les valeurs mesurées exactes peut entraîner une répartition irrégulière des bandes de fréquence. Les courbes proposées ici tentent de dégager des données de mesure une progression régulière et plausible.</p><ul style=\"margin:0 0 8px;padding-left:1.4em\"><li>Vérifiez si l’une des courbes se rapproche de votre mesure. Les points colorés vert/orange/rouge indiquent la qualité de l’ajustement.</li><li>Les barres de résidus en forme de T indiquent l’incertitude de mesure ; mieux la courbe passe par les résidus, mieux elle correspond à vos résultats.</li><li>Les électrodes signalées comme problématiques, p. ex. bruitées, peuvent s’écarter fortement.</li></ul><p style=\"margin:0\">Les deux méthodes affines de position sont particulièrement recommandées. Elles estiment, à partir des valeurs mesurées, la position réelle de l’implant dans la cochlée et ajustent le décalage de fréquence en conséquence.</p>",
